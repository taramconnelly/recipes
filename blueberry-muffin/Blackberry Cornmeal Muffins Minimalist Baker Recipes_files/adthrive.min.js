...
return a}function Aa(a){var b=typeof a;return null!=a&&("object"==b||"function"==b)}function Cd(a){if(!Aa(a))return!1;a=vb(a);return"[object Function]"==a||"[object GeneratorFunction]"==a||"[object AsyncFunction]"==a||"[object Proxy]"==a}function Dd(a,b){a=null==a?void 0:a[b];if(!Aa(a)||Ci&&Ci in a)var c=!1;else{b=Cd(a)?pk:qk;var d=b.test;b:if(null!=a){try{c=rk.call(a);break b}catch(e){}c=a+""}else c="";c=d.call(b,c)}return c?a:void 0}function Ua(a){var b=-1,c=null==a?0:a.length;for(this.clear();++b<
c;){var d=a[b];this.set(d[0],d[1])}}function jc(a,b){a=a.__data__;var c=typeof b;return("string"==c||"number"==c||"symbol"==c||"boolean"==c?"__proto__"!==b:null===b)?a["string"==typeof b?"string":"hash"]:a.map}function db(a){var b=-1,c=null==a?0:a.length;for(this.clear();++b<c;){var d=a[b];this.set(d[0],d[1])}}function eb(a){this.size=(this.__data__=new Ia(a)).size}function Ed(a,b,c){"__proto__"==b&&kc?kc(a,b,{configurable:!0,enumerable:!0,value:c,writable:!0}):a[b]=c}function Fd(a,b,c){(void 0===
c||hc(a[b],c))&&(void 0!==c||b in a)||Ed(a,b,c)}function Di(a){var b=a&&a.constructor;return a===("function"==typeof b&&b.prototype||sk)}function fb(a){return null!=a&&"object"==typeof a}function Ei(a){return fb(a)&&"[object Arguments]"==vb(a)}function Fi(a){return"number"==typeof a&&-1<a&&0==a%1&&9007199254740991>=a}function Gd(a){return null!=a&&Fi(a.length)&&!Cd(a)}function tk(){return!1}function uk(a){return fb(a)&&Fi(a.length)&&!!Z[vb(a)]}function vk(a){return function(b){return a(b)}}function Hd(a,
b){if(("constructor"!==b||"function"!==typeof a[b])&&"__proto__"!=b)return a[b]}function Gi(a,b){var c=typeof a;b=null==b?9007199254740991:b;return!!b&&("number"==c||"symbol"!=c&&wk.test(a))&&-1<a&&0==a%1&&a<b}function Hi(a){if(Gd(a)){var b=Id(a),c=!b&&Jd(a),d=!b&&!c&&Ii(a),e=!b&&!c&&!d&&Ji(a);if(b=b||c||d||e){c=a.length;for(var g=String,h=-1,m=Array(c);++h<c;)m[h]=g(h);c=m}else c=[];g=c.length;for(var q in a)b&&("length"==q||d&&("offset"==q||"parent"==q)||e&&("buffer"==q||"byteLength"==q||"byteOffset"==
q)||Gi(q,g))||c.push(q);a=c}else if(Aa(a)){q=Di(a);e=[];for(d in a)("constructor"!=d||!q&&xk.call(a,d))&&e.push(d);a=e}else{q=[];if(null!=a)for(e in Object(a))q.push(e);a=q}return a}function Ki(a,b,c,d,e){a!==b&&yk(b,function(g,h){e||(e=new eb);if(Aa(g)){g=e;var m=Hd(a,h),q=Hd(b,h),w=g.get(q);if(w)Fd(a,h,w);else{var u=d?d(m,q,h+"",a,b,g):void 0;if(w=void 0===u){var v=Id(q),A=!v&&Ii(q),G=!v&&!A&&Ji(q);u=q;if(v||A||G)if(Id(m))u=m;else if(fb(m)&&Gd(m))for(u=void 0,v=-1,A=m.length,u||(u=Array(A));++v<
A;)u[v]=m[v];else A?(w=!1,u=q.slice()):G?(w=!1,m=q.buffer,u=new m.constructor(m.byteLength),(new Li(u)).set(new Li(m)),u=new q.constructor(u,q.byteOffset,q.length)):u=[];else if(fb(q)&&"[object Object]"==vb(q)?(v=Mi(q),null===v?v=!0:(v=zk.call(v,"constructor")&&v.constructor,v="function"==typeof v&&v instanceof v&&Ni.call(v)==Ak)):v=!1,v||Jd(q))if(u=m,Jd(m)){u=Hi(m);v=void 0;A=!v;v||(v={});G=-1;for(var L=u.length;++G<L;){var J=u[G],D=void 0;void 0===D&&(D=m[J]);if(A)Ed(v,J,D);else{var P=v,M=P[J];
Bk.call(P,J)&&hc(M,D)&&(void 0!==D||J in P)||Ed(P,J,D)}}u=v}else{if(!Aa(m)||Cd(m))u="function"!=typeof q.constructor||Di(q)?{}:Ck(Mi(q))}else w=!1}w&&(g.set(q,u),Ki(u,q,c,d,g),g["delete"](q));Fd(a,h,u)}}else q=d?d(Hd(a,h),g,h+"",a,b,e):void 0,void 0===q&&(q=g),Fd(a,h,q)},Hi)}function Oi(a){return a}function Dk(a,b,c){switch(c.length){case 0:return a.call(b);case 1:return a.call(b,c[0]);case 2:return a.call(b,c[0],c[1]);case 3:return a.call(b,c[0],c[1],c[2])}return a.apply(b,c)}function Ek(a,b,c){b=
Pi(void 0===b?a.length-1:b,0);return function(){for(var d=arguments,e=-1,g=Pi(d.length-b,0),h=Array(g);++e<g;)h[e]=d[b+e];e=-1;for(g=Array(b+1);++e<b;)g[e]=d[e];g[b]=c(h);return Dk(a,this,g)}}function Fk(a){return function(){return a}}function Gk(a,b){return Hk(Ek(a,b,Oi),a+"")}function gb(a,b){void 0===b&&(b={});b=b.insertAt;if(a&&"undefined"!==typeof document){var c=document.head||document.getElementsByTagName("head")[0],d=document.createElement("style");d.type="text/css";"top"===b?c.firstChild?
c.insertBefore(d,c.firstChild):c.appendChild(d):c.appendChild(d);d.styleSheet?d.styleSheet.cssText=a:d.appendChild(document.createTextNode(a))}}function Qi(a){if("number"==typeof a)return a;var b=a;if("symbol"==typeof b||fb(b)&&"[object Symbol]"==vb(b))return Ri;Aa(a)&&(a="function"==typeof a.valueOf?a.valueOf():a,a=Aa(a)?a+"":a);if("string"!=typeof a)return 0===a?a:+a;if(a){b=a.slice;for(var c=a.length;c--&&Ik.test(a.charAt(c)););a=b.call(a,0,c+1).replace(Jk,"")}return(b=Kk.test(a))||Lk.test(a)?
...
u;if(J)return clearTimeout(v),v=setTimeout(g,b),d(A)}void 0===v&&(v=setTimeout(g,b));return u}var q,w,u,v,A,G=0,L=!1,J=!1,D=!0;if("function"!=typeof a)throw new TypeError("Expected a function");b=Qi(b)||0;if(Aa(c)){L=!!c.leading;var P=(J="maxWait"in c)?Pk(Qi(c.maxWait)||0,b):P;D="trailing"in c?!!c.trailing:D}m.cancel=function(){void 0!==v&&clearTimeout(v);G=0;q=A=w=v=void 0};m.flush=function(){return void 0===v?u:h(Ka.Date.now())};return m}function Kd(a,b,c){var d=!0,e=!0;if("function"!=typeof a)throw new TypeError("Expected a function");
Aa(c)&&(d="leading"in c?!!c.leading:d,e="trailing"in c?!!c.trailing:e);return Si(a,b,{leading:d,maxWait:b,trailing:e})}window.adthrive.buildDate="2023-08-02";let dc=new WeakMap;Object.assign(Reflect,{decorate:function(a,b,c,d){if(!Array.isArray(a)||0===a.length)throw new TypeError;if(void 0!==c)return ik(a,b,c,d);if("function"===typeof b)return jk(a,b)},defineMetadata:function(a,b,c,d){yi(a,b,c,d)},getMetadata:function(a,b,c){return zd(a,b,c)},getOwnMetadata:function(a,b,c){return ec(a,b,c)},hasMetadata:function(a,
b,c){return!!zd(a,b,c)},hasOwnMetadata:function(a,b,c){return!!ec(a,b,c)},metadata:function(a,b){return function(c,d){yi(a,b,c,d)}}});var Ld;(function(a){a[a.Transient=0]="Transient";a[a.Singleton=1]="Singleton";a[a.ResolutionScoped=2]="ResolutionScoped";a[a.ContainerScoped=3]="ContainerScoped"})(Ld||(Ld={}));var pa=Ld,Bd=function(a,b){Bd=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(c,d){c.__proto__=d}||function(c,d){for(var e in d)d.hasOwnProperty(e)&&(c[e]=d[e])};return Bd(a,
...
b();return Reflect[d].apply(void 0,Ta(e))}});return c};return a}(),Md=function(){function a(){this._registryMap=new Map}a.prototype.entries=function(){return this._registryMap.entries()};a.prototype.getAll=function(b){this.ensure(b);return this._registryMap.get(b)};a.prototype.get=function(b){this.ensure(b);b=this._registryMap.get(b);return b[b.length-1]||null};a.prototype.set=function(b,c){this.ensure(b);this._registryMap.get(b).push(c)};a.prototype.setAll=function(b,c){this._registryMap.set(b,c)};
a.prototype.has=function(b){this.ensure(b);return 0<this._registryMap.get(b).length};a.prototype.clear=function(){this._registryMap.clear()};a.prototype.ensure=function(b){this._registryMap.has(b)||this._registryMap.set(b,[])};return a}(),Qk=function(a){function b(){return null!==a&&a.apply(this,arguments)||this}Ad(b,a);return b}(Md),Ui=function(){return function(){this.scopedResolutions=new Map}}(),Rk=function(a){function b(){return null!==a&&a.apply(this,arguments)||this}Ad(b,a);return b}(Md),Sk=
function(a){function b(){return null!==a&&a.apply(this,arguments)||this}Ad(b,a);return b}(Md),Tk=function(){return function(){this.preResolution=new Rk;this.postResolution=new Sk}}(),Ai=new Map,F=new (function(){function a(b){this.parent=b;this._registry=new Qk;this.interceptors=new Tk}a.prototype.register=function(b,c,d){void 0===d&&(d={lifecycle:pa.Transient});c=c.useClass||void 0!=c.useValue||c.useToken||c.useFactory?c:{useClass:c};if(c.useToken)for(var e=[b],g=c;null!=g;){g=g.useToken;if(e.includes(g))throw Error("Token registration cycle detected! "+
Ta(e,[g]).join(" -> "));e.push(g);g=(g=this._registry.get(g))&&g.provider.useToken?g.provider:null}if(d.lifecycle===pa.Singleton||d.lifecycle==pa.ContainerScoped||d.lifecycle==pa.ResolutionScoped)if(void 0!=c.useValue||c.useFactory)throw Error('Cannot use lifecycle "'+pa[d.lifecycle]+'" with ValueProviders or FactoryProviders');this._registry.set(b,{provider:c,options:d});return this};a.prototype.registerType=function(b,c){return cb(c)?this.register(b,{useToken:c}):this.register(b,{useClass:c})};
a.prototype.registerInstance=function(b,c){return this.register(b,{useValue:c})};a.prototype.registerSingleton=function(b,c){if(cb(b)){if(cb(c))return this.register(b,{useToken:c},{lifecycle:pa.Singleton});if(c)return this.register(b,{useClass:c},{lifecycle:pa.Singleton});throw Error('Cannot register a type name as a singleton without a "to" token');}var d=b;c&&!cb(c)&&(d=c);return this.register(b,{useClass:d},{lifecycle:pa.Singleton})};a.prototype.resolve=function(b,c){void 0===c&&(c=new Ui);var d=
this.getRegistration(b);if(!d&&cb(b))throw Error('Attempted to resolve unregistered dependency token: "'+b.toString()+'"');this.executePreResolutionInterceptor(b,"Single");if(d)return c=this.resolveRegistration(d,c),this.executePostResolutionInterceptor(b,c,"Single"),c;if("function"===typeof b||b instanceof Ti)return c=this.construct(b,c),this.executePostResolutionInterceptor(b,c,"Single"),c;throw Error("Attempted to construct an undefined constructor. Could mean a circular dependency problem. Try using `delay` function.");
...
function(b,c){var d=this;void 0===c&&(c=new Ui);var e=this.getAllRegistrations(b);if(!e&&cb(b))throw Error('Attempted to resolve unregistered dependency token: "'+b.toString()+'"');this.executePreResolutionInterceptor(b,"All");if(e)return e=e.map(function(g){return d.resolveRegistration(g,c)}),this.executePostResolutionInterceptor(b,e,"All"),e;e=[this.construct(b,c)];this.executePostResolutionInterceptor(b,e,"All");return e};a.prototype.isRegistered=function(b,c){void 0===c&&(c=!1);return this._registry.has(b)||
...
function(b){return this.isRegistered(b)?this._registry.getAll(b):this.parent?this.parent.getAllRegistrations(b):null};a.prototype.construct=function(b,c){var d=this;if(b instanceof Ti)return b.createProxy(function(g){return d.resolve(g,c)});var e=Ai.get(b);if(!e||0===e.length){if(0===b.length)return new b;throw Error('TypeInfo not known for "'+b.name+'"');}e=e.map(this.resolveParams(c,b));return new (b.bind.apply(b,Ta([void 0],e)))};a.prototype.resolveParams=function(b,c){var d=this;return function(e,
g){var h,m,q;try{return"object"===typeof e&&"token"in e&&"multiple"in e?zi(e)?e.multiple?(h=d.resolve(e.transform)).transform.apply(h,Ta([d.resolveAll(e.token)],e.transformArgs)):(m=d.resolve(e.transform)).transform.apply(m,Ta([d.resolve(e.token,b)],e.transformArgs)):e.multiple?d.resolveAll(e.token):d.resolve(e.token,b):zi(e)?(q=d.resolve(e.transform,b)).transform.apply(q,Ta([d.resolve(e.token,b)],e.transformArgs)):d.resolve(e,b)}catch(w){throw e=Error,h=w,m=gc(c.toString().match(/constructor\(([\w, ]+)\)/)||
[],2)[1],m=void 0===m?null:m,g=null===m?"at position #"+g:'"'+m.split(",")[g].trim()+'" at position #'+g,g=lk("Cannot inject the dependency "+g+' of "'+c.name+'" constructor. Reason:',h),new e(g);}}};return a}());if("undefined"===typeof Reflect||!Reflect.getMetadata)throw Error("tsyringe requires a reflect polyfill. Please add 'import \"reflect-metadata\"' to the top of your entry point.");class Vi{}let Nd=class extends Vi{constructor(){super(...arguments);this.name="StorageHandler";this.disable=
...
{let b=a.clientWidth;getComputedStyle&&(a=getComputedStyle(a,null),b-=parseFloat(a.paddingLeft||"0")+parseFloat(a.paddingRight||"0"));return b},Ud=a=>{const b=a.offsetHeight,c=a.offsetWidth;var d=a.getBoundingClientRect();const e=document.body,g=document.documentElement;a=Math.round(d.top+(window.pageYOffset||g.scrollTop||e.scrollTop)-(g.clientTop||e.clientTop||0));d=Math.round(d.left+(window.pageXOffset||g.scrollLeft||e.scrollLeft)-(g.clientLeft||e.clientLeft||0));return{top:a,left:d,bottom:a+b,
...
"uav":void 0;var d=navigator&&16<navigator.hardwareConcurrency?"hwv":void 0;a=[a,b,c,d,hl()].filter(e=>!!e);return a.length?a:void 0},qa=(a=navigator.userAgent)=>/Windows NT|Macintosh/i.test(a),Yd=a=>!!(a.offsetWidth||a.offsetHeight||a.getClientRects().length);var zb;(function(a){a.amznbid="amznbid";a.amzniid="amzniid";a.amznp="amznp";a.amznsz="amznsz"})(zb||(zb={}));var f;(function(a){a.ThirtyThreeAcross="33across";a.AppNexus="appnexus";a.Amazon="amazon";a.Colossus="colossus";a.ColossusServer="col_ss";
...
a.highSequence="highsequence";a.lazyBidPool="lazyBidPool";a.rubicon="rubicon"})(R||(R={}));var Zd;(function(a){a.bidCycleNonlazy="bc";a.instream="i";a.lazy="l";a.refresh="r";a.session="s";a.crossdomain="c";a.highsequence="hs";a.rubicon="rubi";a.lazyBidPool="lbp"})(Zd||(Zd={}));var da;(function(a){a.Version="Version";a.SharingNotice="SharingNotice";a.SaleOptOutNotice="SaleOptOutNotice";a.SharingOptOutNotice="SharingOptOutNotice";a.TargetedAdvertisingOptOutNotice="TargetedAdvertisingOptOutNotice";a.SensitiveDataProcessingOptOutNotice=
...
e),864E5)})},sj=Math.pow(2,48)-1,tl=(a,b)=>{if(isNaN(a))throw Error(`${a} must be a number`);if(a>sj)throw a=Error(`cannot encode time greater than ${sj}`),a.source="ulid",a;let c,d="";for(;0<b;b--)c=a%32,d="0123456789ABCDEFGHJKMNPQRSTVWXYZ".charAt(c)+d,a=(a-c)/32;return d},ul=(a,b)=>{let c="";for(;0<a;a--){let d=Math.floor(32*b());32===d&&(d=31);c="0123456789ABCDEFGHJKMNPQRSTVWXYZ".charAt(d)+c}return c},jb=()=>tl(Date.now(),10)+ul(16,()=>{if(window.crypto){var a=new Uint8Array(1);crypto.getRandomValues(a);
a=a[0]/255}else a=Math.random();return a}),tj=a=>new Promise(b=>setTimeout(b,a)),ce=async({condition:a,delay:b=500,maxAttempts:c=10,executedAttempts:d=0})=>{if(!a()){if(d>=c)throw Error("Max waitFor attempts reached without resolution");await tj(b);return await ce({condition:a,delay:b,maxAttempts:c,executedAttempts:d+1})}},I=class{constructor(){this._map=new Map;this.setAbGroup=!Wa().has("at_features")}set(a,b){this.setAbGroup&&this._map.set(a,b)}get(a){return this._map.get(a)}get groups(){let a=
[];for(let [b,c]of this._map)Array.isArray(c)?c.forEach(d=>{a.push(`${b}:${d}`)}):a.push(`${b}:${c}`);return a}get groupsAsObject(){let a={};for(let b of this._map.keys()){let c=this._map.get(b);c&&(a[b]=c)}return a}};I=l([p(),k("design:paramtypes",[])],I);let ya=class extends I{};ya=l([p()],ya);let de=class{constructor(){this.adthriveExperimentOverrides=this.getExperimentOverrides()}getExperimentOverrides(){let a={},b=Wa().get("at_features");if(b)try{let c=decodeURIComponent(b);a=JSON.parse(c);r.event("ExperimentOverrides",
...
b.key.toLowerCase()===a.toLowerCase())[0]}}let Da=class extends ge{constructor(a){var b;super(a.siteAds);this._players=null===(b=a.siteAds.videoPlayers)||void 0===b?void 0:b.players}getVideoPlaylistByType(a){var b,c;return null!==(c=null===(b=this._players)||void 0===b?void 0:b.filter(d=>d.type===a))&&void 0!==c?c:[]}};Da=l([p(),U(0,T("AdThrive")),k("design:paramtypes",[Object])],Da);let vl=a=>{let b=0;a.forEach(c=>{c.weight&&(b+=c.weight)});return 0<a.length&&a.every(c=>!(!c.hasOwnProperty("value")||
...
canDisplay:c,message:d}=vj();var e=Q()&&B(a.siteAds.adOptions.mobileInterstitial,!1);a=!Q()&&B(a.siteAds.adOptions.desktopInterstitial,!1);b&&r.error("InterstitialExperiment","canDisplayInterstitial",{message:d});return c&&(e||a)?(e=F.resolve(sc))&&e.result&&"off"!==e.result?!0:!1:!1}};vc=l([p(),U(0,T("AdThrive")),k("design:paramtypes",[Object,tc,uc])],vc);let he=class{constructor(a){a=a.siteAds.adTypes||{};this.animatedFooter=B(a.animatedFooter,!0);this.expandableFooter=B(a.expandableFooter,!0);
...
a[b].min)}get outstreamEnabled(){return Q()?!0===this.outstreamMobile:!0===this.outstreamDesktop}};he=l([p(),U(0,T("AdThrive")),k("design:paramtypes",[Object])],he);let ie=(a=navigator.userAgent)=>/iP(hone|od|ad)/i.test(a),xl=(a,b=navigator.userAgent)=>(new RegExp(`OS ${a}`,"i")).test(b),wj=(a,b=navigator.userAgent)=>ie(b)&&xl(a.toString(),b),yl=(a=navigator.userAgent)=>Sd(a)&&qa(a),wc=class extends K{constructor(a,b,c){super();this._result=!0;this.key="amzn";this._choices=[{choice:!0},{choice:!1}];
...
"Failed to set mcmp data",b)}}};ve=l([n("RecencyAndFrequencyIFrameManager"),p(),k("design:paramtypes",[ma,Ga])],ve);let we=class{constructor(a,b,c,d,e,g,h,m){this._bootstrapConfig=a;this._bootstrapEventBus=b;this._amazon=c;this._gam=d;this._marmalade=e;this._prebid=g;this._floors=h;this._webVitals=m;F.resolve(ve)}async run(){let a=this._run(()=>this._floors.get(),ra.Floors),b,c;this.loadNonBlockingLibraries();return Promise.all([this._run(()=>this._gam.load(),ra.GAM,{required:!0}).catch(d=>this.gamFallback(d&&
...
g(h.message)});return d?a:Promise.resolve(g(!0))}};we=l([t(),k("design:paramtypes",[ma,qc,ke,le,me,ne,te,ue])],we);let xe=class{constructor(a,b){this.pubId="4fbba76f-7987-4fa2-9733-c27eb3a2170b";this.adUnitExclusions=new Set(["Interstitial"]);this.enabled=b.amazonEnabled&&!0===a.siteAds.adOptions.amazonUAM}};xe=l([p(),U(0,T("AdThrive")),k("design:paramtypes",[Object,ma])],xe);let ye=class{constructor(a){this._bootstrapConfig=a;this.nonCompliantBidders=["unruly"];this.ccpaNotApplicable="1---";this.consentChange=
...
{r.event("Context","sessionLogger",{gaCookie:Ba("_ga"),gidCookie:Ba("_gid"),sessionId:a,ua:navigator.userAgent})})},kb=class{constructor(a){this.connectionTargeting=[];this.sessionData={key:"session_key",timeout:864E5,rolling:!0,cb:P=>{H.removeLocalStorageValue("fpv");Bl(P)}};let {bucket:b,core:c,plugin:d,branch:e,debug:g,deployment:h,baseUrl:m,fastAds:q,siteAds:w,styleUrl:u,invalidTraffic:v,integration:A,deliveryVersion:G}=a,{tablet:L,desktop:J}=w.breakpoints;this.baseUrl=m;this.branch=e;this.bucket=
b;this.country=c&&c.country;this.plugin=d;this.fastAds=q;this.invalidTraffic=v;this.deployment=h;this.domain=window.location.host;this.device=pc(L,J);this.pageUrl=window.location.href;this.pageviewKey=jb();a=this.querystring=Wa();this.sessionKey=this.setSessionKey();this.styleUrl=u;this.debug=g;this.integration=A;this.deliveryVersion=G;this.fledgeSupported=!!navigator.runAdAuction;this.savedReferrer=H.getLocalStorageValue("referrer",!0,18E5);this.isFirstPageview=this.checkIsFirstPageview();try{var D=
...
a}get videoDisabledFromPlugin(){return this._clsGlobalData.videoDisabledFromPlugin}set targetDensityLog(a){this._clsGlobalData.targetDensityLog=a}get targetDensityLog(){return this._clsGlobalData.targetDensityLog}get removeVideoTitleWrapper(){return this._clsGlobalData.siteAds.adOptions.removeVideoTitleWrapper}}let ze=class{constructor(a,b,c,d){this._context=b;this._abgroup=c;this._clsOptions=d;this._defaultHeight=250;this._map=new Map([["phone",{Content:250,Recipe:250,Header:50,Footer:50,Below_Post:250,
...
this.clear=()=>{this.video=this.recipe=this.content=this.all=!1;this.locations=new Set;this.reasons=new Set};this._log=c=>{};this.init()}removeClsDivs(a){if(this._clsOptions.enabled){var b=this._clsOptions.injectedSlots.filter(c=>{const d=c.element;c=!1;d.parentNode&&a.some(e=>d.classList.contains(e))&&(d.parentNode.removeChild(d),c=!0);return!c});this._clsOptions.overwriteInjectedSlots(b)}}disableAllAds(a){if(!a||ae(a))this.all=!0,this.reasons.add("all_page"),this.removeClsDivs(this._clsDivs);this._log("disableAllAds")}disableContentAds(a){if(!a||
ae(a))this.recipe=this.content=!0,this.locations.add("Content"),this.locations.add("Recipe"),this.reasons.add("content_page"),this.removeClsDivs(["adthrive-content","adthrive-recipe"]);this._log("disableContentAds")}disablePlaylistPlayers(a){if(!a||ae(a))this.video=!0,this.locations.add("Video"),this.reasons.add("video_page"),this.adthrive.siteAds.videoPlayers?this._removeCLSVideoPlayers():this._removeLegacyCLSVideoPlayers();this._log("disablePlaylistPlayers")}_removeCLSVideoPlayers(){var a;null===
...
a[c];null===(b=d.parentNode)||void 0===b?void 0:b.removeChild(d)}}urlHasEmail(a){return a?null!==/([A-Z0-9._%+-]+(@|%(25)*40)[A-Z0-9.-]+\.[A-Z]{2,})/i.exec(a):!1}};Be=l([p(),U(0,T("AdThrive")),k("design:paramtypes",[Object,Hb])],Be);class xj extends Eb{constructor(){super(...arguments);this._default=["none"]}get _choices(){return this._coreExperimentConfig.getMultivalueBernoulliVariants(this.key)}run(){var a=this._choices;a&&(a=a.filter(b=>(new O(b.weight/100)).get()).map(b=>b.choice),a.length&&(this._result=
a));return this._result||this._default}}let Ce=class extends xj{init(){this._setAbGroup=!1;this._key="doba"}};Ce=l([n("DOBAExperiment"),p()],Ce);let De=class{constructor(a){this.bidders=a.result||["none"]}};De=l([p(),k("design:paramtypes",[Ce])],De);let xc=class extends K{constructor(a,b){var c;super();this.abgroup=b;this._result=!1;this.key="parallax";this._choices=[{choice:!0},{choice:!1}];this.weight=.5;this.shouldUseCoreOverride=!1;var d=window.adthriveCLS;d=d&&d.experiments;a=null===(c=null===
...
l([N(),k("design:type",Function),k("design:paramtypes",[]),k("design:returntype",void 0)],yc.prototype,"run",null);yc=l([p(),k("design:paramtypes",[Da,ya])],yc);let Ee=class extends K{constructor(a){super();this._result=!1;this._choices=[{choice:!0},{choice:!1}];this.shouldUseCoreExperimentsConfig=!1;this.key="conmax99";var b=window.adthriveCLS;this._result=(b=b&&b.experiments)&&this.key in b?b[this.key]:this.run();a.set(this.key,this._result?"on":"off")}get result(){return this._result}run(){return(new O(.02)).get()}};
Ee=l([n("MaxContentExperiment"),p(),k("design:paramtypes",[I])],Ee);let Fe=class extends K{constructor(a){super();this._result=!1;this._choices=[{choice:!0},{choice:!1}];this.shouldUseCoreExperimentsConfig=!1;this.key="smhd100";var b=window.adthriveCLS;this._result=(b=b&&b.experiments)&&this.key in b?b[this.key]:this.run();a.set(this.key,this._result?"on":"off")}get result(){return this._result}run(){return(new O(.1)).get()}};Fe=l([n("RemoveLargeSizeExperiment"),p(),k("design:paramtypes",[I])],Fe);
let Ge=class extends K{constructor(a){super();this._result=!1;this._choices=[{choice:!0},{choice:!1}];this.shouldUseCoreExperimentsConfig=!1;this.key="mrsf";var b=window.adthriveCLS;(b=b&&b.experiments)&&this.key in b?(this._result=b[this.key],a.set(this.key,this._result?"on":"off")):Q()&&(this._result=this.run(),a.set(this.key,this._result?"on":"off"))}get result(){return this._result}run(){return(new O(1)).get()}};Ge=l([n("MobileRecipeSizeFilterExperiment"),p(),k("design:paramtypes",[I])],Ge);let He=
...
threshold:.05},{choice:"unruly",threshold:.01},{choice:"verizon",threshold:.01},{choice:"yahoossp",threshold:.01},{choice:"yieldmo",threshold:.1}];this.key="hbho";this._result=this.run();this.result.length||(this._result=["none"])}get result(){return this._result}run(){return this._choices.filter(({threshold:a})=>(new O(a)).get()).map(({choice:a})=>a)}};Ne=l([n("HBHOExperiment"),p(),k("design:paramtypes",[])],Ne);let Oe=class{constructor(a){this.bidders=a.result}};Oe=l([p(),k("design:paramtypes",
[Ne])],Oe);let Pe=class{constructor(a){this.apiReady=new z;this.optIn=new z;this._liveRampATS=B(a.siteAds.adOptions.liveRampATS,!1)}get enabled(){return this._liveRampATS}};Pe=l([p(),U(0,T("AdThrive")),k("design:paramtypes",[Object])],Pe);let Ac=class extends K{constructor(a){super();this._abgroup=a;this._choices=[{choice:{name:"id5Id",threshold:.05}},{choice:{name:"identityLink",threshold:.01}},{choice:{name:"pairId",threshold:.01}},{choice:{name:"unifiedId",threshold:.01}},{choice:{name:"unifiedId2",
...
(new O(a.threshold)).get()).map(({choice:a})=>a.name)}};Ac=l([n("IDHOExperiment"),p(),k("design:paramtypes",[I])],Ac);let Qe=class{constructor(a){this.subModule=a.result;this.percentages=a._choices.map(({choice:b})=>`${b.name}:${"number"===typeof b.threshold?100*b.threshold:0}`)}};Qe=l([p(),k("design:paramtypes",[Ac])],Qe);let Re=class extends ea{init(){this._key="loglev";this._default=!1}};Re=l([n("EventLogExperiment"),p()],Re);let Se=class{constructor(a){this.enabled=a.result}};Se=l([p(),k("design:paramtypes",
[Re])],Se);let Te=class{constructor(){this.refreshSlots=new Set(["Footer"]);this.ajaxType=!1}};Te=l([p()],Te);let Bc=class extends Y{init(){this._key="lzbpvp"}run(){return super.run()}};l([N(),k("design:type",Function),k("design:paramtypes",[]),k("design:returntype",void 0)],Bc.prototype,"run",null);Bc=l([n("BelowPostMarginExperiment"),p()],Bc);let Cc=class extends Y{init(){this._key="lzcvp"}run(){return super.run()}};l([N(),k("design:type",Function),k("design:paramtypes",[]),k("design:returntype",
void 0)],Cc.prototype,"run",null);Cc=l([n("ContentMarginExperiment"),p()],Cc);let Ue=class{constructor(a,b){var c,d;this._defaultViewPort=2;this._infScrollViewPort=4;this.googleLazyLoadSettings={disabled:{fetchMarginPercent:-1,renderMarginPercent:-1,mobileScaling:-1},gam:{fetchMarginPercent:600,renderMarginPercent:100,mobileScaling:1.5},hbMarginPercent:700};this.lzhb=!0;this.viewports={content:null!==(c=a.result)&&void 0!==c?c:2,belowPost:null!==(d=b.result)&&void 0!==d?d:.75,default:this._defaultViewPort,
infScroll:this._infScrollViewPort}}};Ue=l([p(),k("design:paramtypes",[Cc,Bc])],Ue);let Ve=class{constructor(a){this._id="69e75073-3763-483e-a64c-0d281bfd9225";this.url=`https://launchpad-wrapper.privacymanager.io/${this._id}/launchpad-liveramp.js`;this.enabled=B(a.siteAds.adOptions.liveRampATS,!0)}};Ve=l([p(),U(0,T("AdThrive")),k("design:paramtypes",[Object])],Ve);let Cl={AS:{location:"Sponsor_Tile",selectors:"h1.entry-title;h1.post-title;h1.posttitle;h1.story-title;h1.heading;.post > .post-title".split(";"),
...
return!a.requireSelectorMatch||!!b}return!0}_getMcmpFlpIds(){return this.campaigns.filter(a=>this._isValidMarmaladeCampaign(a)).reduce((a,b)=>{a.mcmp.push(b.dfp_id);b.flp_prod_id&&a.flpProdIds.push(...JSON.parse(b.flp_prod_id));return a},{mcmp:[],flpProdIds:[]})}_parseDate(a){a=a.split("-");return new Date(Number(a[0]),Number(a[1])-1,Number(a[2]))}};Dc=l([p(),U(0,T("RecencyFrequencyMarmaladeResponse")),k("design:paramtypes",[Object,Ga])],Dc);let We=class{constructor(a){this._biddersConfig=new Map;
...
(new O(a)).get()).map(({choice:a})=>a)}};jf=l([n("VBHOExperiment"),p(),k("design:paramtypes",[])],jf);let kf=class{constructor(a){this.bidders=a.result}};kf=l([p(),k("design:paramtypes",[jf])],kf);let Nb=class extends Y{init(){this._key="cbt"}run(){return super.run()}};l([N(),k("design:type",Function),k("design:paramtypes",[]),k("design:returntype",void 0)],Nb.prototype,"run",null);Nb=l([n("CloseButtonTimeoutExperiment"),p()],Nb);let Ob=class extends K{constructor(a){super();this.shouldUseCoreExperimentsConfig=
...
"setExperimentTargeting","() => %o","Experiment targeting requires an experiment config")}};l([N(),k("design:type",Function),k("design:paramtypes",[]),k("design:returntype",void 0)],Gc.prototype,"run",null);Gc=l([p(),k("design:paramtypes",[Da,ya])],Gc);let Hc=class extends Ya{constructor(a,b){super();this._siteExperiments=a;this._pubabgroup=b;this._choices=[];this._result=!1;this.key=sa.VideoAdvancePlaylistRelatedPlayer;this.experimentConfig=this._siteExperiments.getSiteExperimentByKey(this.key);
...
p(),U(0,T("AdThrive")),k("design:paramtypes",[Object,I,aa])],Jc);let Kc=class extends Y{init(){this._key="reqTo"}run(){return super.run()}};l([N(),k("design:type",Function),k("design:paramtypes",[]),k("design:returntype",void 0)],Kc.prototype,"run",null);Kc=l([n("JwRequestTimeoutExperiment"),p()],Kc);let lf=class extends ea{init(){this._key="LogAdDurationExperiment";this._default=!1}};lf=l([n("LogAdDurationExperiment"),p()],lf);let mf=class extends ea{init(){this._key="LogAdLifeCycleExperiment";this._default=
!1}};mf=l([n("LogAdLifeCycleExperiment"),p()],mf);let Lc=class extends K{constructor(a,b){super();this._result=!0;this.key="pbm";this._choices=[{choice:!0},{choice:!1}];this._map=new Map([[x.Video_In_Post_ClicktoPlay_SoundOn,[3]],[x.Video_Collapse_Autoplay_SoundOff,[6]],[x.Video_Coll_SOff_Smartphone,[6]],[x.Video_Individual_Autoplay_SOff,[6]]]);this.weight=1;if(b=b.getCoreExperimentButMutateWeights(this.key))this.weight=b.variants[0].weight,this.playbackmethod=(this._result=this.run())?this._map:
void 0,a.set(this.key,this._result?"on":"off")}get result(){return this._result}run(){return(new O(this.weight)).get()}};l([N(),k("design:type",Function),k("design:paramtypes",[]),k("design:returntype",void 0)],Lc.prototype,"run",null);Lc=l([n("PlaybackmethodExperiment"),p(),k("design:paramtypes",[I,aa])],Lc);let nf=class extends ea{init(){this._key="csp";this._default=!1}};nf=l([n("ContentSpecificPlaylistExperiment"),p()],nf);let El=a=>{const b=[],c=[];a.forEach(d=>{d.isDraft||(d.categories.some(e=>
{e=ib(`.adthrive-cat-${e}`);return e.valid&&e.elements&&e.elements.length})?b.push(d.playlistId):0===d.categories.length&&c.push(d.playlistId))});a=0<b.length?b:c;return a[Math.floor(Math.random()*a.length)]},of=a=>{if(F.resolve(nf).result&&a.length)return El(a)},pf=class extends Y{init(){this._key="osp"}run(){return super.run()}};pf=l([n("OutstreamPlacementExperiment"),p()],pf);let Mc=class extends ea{init(){this._key="nosvp";this._default=!1}run(){return super.run()}};l([N(),k("design:type",Function),
k("design:paramtypes",[]),k("design:returntype",void 0)],Mc.prototype,"run",null);Mc=l([n("OutstreamRendererExperiment"),p()],Mc);let qf=class{constructor(a,b,c,d,e,g,h,m,q,w,u){var v;this.players=[];this.instreamAdUnits=new Set([x.Video_Collapse_Autoplay_SoundOff,x.Video_Individual_Autoplay_SOff,x.Video_Coll_SOff_Smartphone,x.Video_In_Post_ClicktoPlay_SoundOn]);this.closeButtonTimeout=B(b.result,4E3);this.vastTimeout=B(c.result,1E4);this.maxRedirect=8;this.apiValue=[2];this.videoWasClosed=B(H.getLocalStorageValue("video_closed",
...
this.logAdLifeCycle=a.logAdLifeCycle;this.vastTimeout=a.vastTimeout;this.videoWasClosed=a.videoWasClosed;this.removeVideoTitleWrapper=e.enabled?e.result:a.removeVideoTitleWrapper;this.players=a.players;this.footerSelector=a.footerSelector;this.stickyOutstreamSettings=a.stickyOutstreamSettings;this.maxDuration=g.result||30;this.contentSpecificPlaylists=a.contentSpecificPlaylists;this.enableNewOutstreamRenderer=a.enableNewOutstreamRenderer}};sf=l([p(),k("design:paramtypes",[qf,Ob,Nb,Pb,Gc,rf])],sf);
let tf=class extends xj{init(){this._setAbGroup=!1;this._key="voba"}};tf=l([n("DOBAExperiment"),p()],tf);let uf=class{constructor(a){this.bidders=a.result||["none"]}};uf=l([p(),k("design:paramtypes",[tf])],uf);let y=class{constructor(a,b,c,d,e,g,h,m,q,w,u,v,A,G,L,J,D,P,M,ca,fa,Oa,mb,nb,Qb,Rb,ob,Sb,pb,Tb,Ub,Za,vf,wf,xf,yf,Nc){this.abGroup=a;this.adOptions=b;this.adTypes=c;this.amazon=d;this.ccpa=e;this.gpc=g;this.clsOptimizedAds=h;this.comscore=m;this.context=q;this.disableAds=w;this.displayOpenBidding=
u;this.ebho=v;this.impressionLog=A;this.floors=G;this.footer=L;this.gam=J;this.gdpr=D;this.hbho=P;this.identityApi=M;this.idho=ca;this.infiniteScroll=fa;this.lazyLoad=Oa;this.liveRampAts=mb;this.marmalade=nb;this.partners=Qb;this.pubAbGroup=Rb;this.prebid=ob;this.site=Sb;this.targetDensity=pb;this.timeouts=Tb;this.timing=Ub;this.tkho=Za;this.user=vf;this.vbho=wf;this.video=xf;this.videoOpenBidding=yf;this._dynamicAdsMapper=Nc;this.dynamicAds=Nc.get();a=F.resolve(Hb);a.enabled&&(this.clsOptions=a)}resetDynamicAds(){this.dynamicAds=
this._dynamicAdsMapper.get()}};y=l([p(),k("design:paramtypes",[I,vc,he,xe,ye,Me,ze,Ae,kb,Be,De,Je,Se,Gb,Ke,zc,Le,Oe,Pe,Qe,Te,Ue,Ve,Dc,We,ya,af,Ec,bf,df,Fc,gf,hf,kf,sf,uf,He])],y);class Bj{constructor(a,b,c,d,e,g=!1,h=8,m,q=[],w=!0,u=!1){this.location=a;this.sequence=b;this.sizes=c;this.element=d;this.sticky=e;this.lazy=g;this.auctionPriority=h;this.stickyOverlapSelector=m;this.special=q;this.enabledForAuction=w;this.infinite=u;this.isRefreshing=this.refreshPaused=!1;this.slotFullyRenderedDuration=
...
!1):a.filter(c=>"off"!==c).every(c=>!isNaN(Number(c)))?!0:(r.error("DCSLLSiteSpecificExperiment","validation","Non-numeric choices found in DCSLL site specific experiment"),!1)},Hl=a=>{const b=a.context.device;var c=(a=null===(c=a.marmalade)||void 0===c?void 0:c.dcsllSiteSpecific)?a[Fl[b]]:void 0;c=null===c||void 0===c?void 0:c.variants.map(({value:d,weight:e})=>({choice:`${d}`,weight:e}));return Gl(c)?c:null},Af=class extends K{constructor(a,b,c){super();this.key="dcsll_ss";this._result="off";this._choices=
[{choice:"off",weight:30},{choice:"5.80",weight:50},{choice:"4.00",weight:10},{choice:"2.00",weight:5},{choice:"0.75",weight:5}];B(b.siteAds.adOptions.dynamicContentSlotLazyLoading,!0)&&(b=Hl(c),this._choices=null!==b&&void 0!==b?b:this._choices,this._result=this.run(),a.set(this.key,this._result))}get result(){return this._result}run(){return(new ta(this._choices)).get()}};Af=l([n("DCSLLSiteSpecificExperiment"),p(),U(1,T("AdThrive")),k("design:paramtypes",[I,Object,y])],Af);let Bf=class extends C{constructor(a,
...
Qc=l([n("UserIdComponent"),t(),k("design:paramtypes",[W,Df,Pa,E,Ha,Ac])],Qc);class Hj{}let Rc=class extends Y{init(){this._key="pba"}run(){return super.run()}};l([N(),k("design:type",Function),k("design:paramtypes",[]),k("design:returntype",void 0)],Rc.prototype,"run",null);Rc=l([n("AnalyticsExperiment"),p()],Rc);let Ef=class extends Hj{constructor(a,b,c){super();this._config=a;this._prebidMethods=b;this._analyticsExperiment=c;this.name="roxot"}init(){if(window.localStorage)try{this._prebidMethods.enableAnalytics({provider:"roxot",
options:{publisherIds:["ffcc0e40-07d0-4238-92e4-f711915afb5a"],host:`${this._config.context.bucket}.com`}})}catch(a){r.error("RoxotAnalytics","init - ignored",a)}else r.error("RoxotAnalytics","init",Error("Disabled roxot because localStorage is undefined"))}get enabled(){return"roxot"===this._analyticsExperiment.result}};Ef=l([n("RoxotAnalytics"),t(),k("design:paramtypes",[y,W,Rc])],Ef);let Ff=class extends Hj{constructor(a,b){super();this._floorsExperiment=a;this._prebidMethods=b;this.name="rubicon"}init(){try{this._prebidMethods.enableAnalytics({provider:this.name,
options:{accountId:9262,endpoint:"https://prebid-a.rubiconproject.com/event"}})}catch(a){r.error("RubiconAnalytics","init - ignored",a)}}get enabled(){return"rubi"===this._floorsExperiment.result}};Ff=l([n("RubiconAnalytics"),t(),k("design:paramtypes",[Fb,W])],Ff);class Il{updateBidParams(a,b){}get enabled(){return!0}get videoEnabled(){return!0}get name(){return this.bidderConfig.bidder_name}_addPositionParam(a,b){a.params.position=b}_addPlacementIdParam(a,b){a.params.placementId=b}_addBidLabel(a,
...
this._slotManager,d=c.getSlot(a),e=!b;if(d){var g=Date.now(),h=d.stickyOutstreamRenderedTimestamp;g=h&&g-h||0;b&&"number"===typeof d.stickyOutstreamErrorCount&&d.stickyOutstreamErrorCount<this._forcedRefreshLimit&&a.includes("StickyOutstream")?(d.stickyOutstreamErrorCount++,e=!0):d.stickyOutstreamErrorCount=0;e&&25E3>g&&c.updateRefreshTimeout(d,1001)}}};Sc=l([t(),k("design:paramtypes",[y,V,Qa])],Sc);let If=class extends K{constructor(a,b,c){super();this._result=!1;this.key="rmosnv1";this._choices=
...
...((null===(e=this._config.video.playbackmethod)||void 0===e?void 0:e.get(a.name))&&{playbackmethod:this._config.video.playbackmethod.get(a.name)})}}}})}}};Wf=l([n("OpenXBidder"),t(),k("design:paramtypes",[y,Jb])],Wf);let ab=class{constructor(a){this._spaEventBus=a;this.segmentName="www.iris.tv";this.segtax=501;this._irisEndpoint="https://context.iris.tv/video_info";this._token="5d8f38ad6d7de4253cfa501b84c30b1014868d9884be5d68dc64bd50a6edb54c";this._clientToken="EXJQESR8SMWMZCJ";this._spaEventBus.routeChanged.on(()=>
...
adSlot:`${b}@${c.size[0]}x${c.size[1]}`,...(this._config.site.filteredSensitiveCategories.length&&{pmzoneid:this._config.site.filteredSensitiveCategories.join(",")})}}}};Xf=l([n("PubMaticBidder"),t(),k("design:paramtypes",[y,ab])],Xf);let Yf=class extends X{constructor(a){super();this._config=a;this.bidderConfig=this._config.partners.getBidderConfig(f.ResetDigital);this.videoCreativeIds=[["138413962354",f.ResetDigital],["138413962351",f.ResetDigital],["138413962348",f.ResetDigital],["138413454348",
...
d=c&&b&&b.length;return[{bidder:this.name,params:{...this._videoParams,channel_id:this._map.get(a.name),...(d&&{custom:{iris_context:b,iris_id:c}})}}]}}};dg=l([n("SpotXBidder"),t(),k("design:paramtypes",[y,ab])],dg);let eg=class extends X{constructor(a,b){super();this._config=a;this._mediaType=b;this.bidderConfig=this._config.partners.getBidderConfig(f.Teads);this._pageId=112062;this._adTypeBitIndexMap=new Map([["outstream",{adType:Q()?"outstreamMobile":"outstreamDesktop",index:1}],["miniscroller",
...
self,Ka=Pj||Ul||Function("return this")(),Tc=Ka.Symbol,Qj=Object.prototype,mk=Qj.hasOwnProperty,nk=Qj.toString,wb=Tc?Tc.toStringTag:void 0,ok=Object.prototype.toString,Bi=Tc?Tc.toStringTag:void 0,tg=Ka["__core-js_shared__"],Ci=function(){var a=/[^.]+$/.exec(tg&&tg.keys&&tg.keys.IE_PROTO||"");return a?"Symbol(src)_1."+a:""}(),rk=Function.prototype.toString,qk=/^\[object .+?Constructor\]$/,pk=RegExp("^"+Function.prototype.toString.call(Object.prototype.hasOwnProperty).replace(/[\\^$.*+?()[\]{}|]/g,
"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$"),Rj=Dd(Ka,"Map"),Zb=Dd(Object,"create"),Vl=Object.prototype.hasOwnProperty,Wl=Object.prototype.hasOwnProperty;Ua.prototype.clear=function(){this.__data__=Zb?Zb(null):{};this.size=0};Ua.prototype["delete"]=function(a){a=this.has(a)&&delete this.__data__[a];this.size-=a?1:0;return a};Ua.prototype.get=function(a){var b=this.__data__;return Zb?(a=b[a],"__lodash_hash_undefined__"===a?void 0:a):Vl.call(b,a)?b[a]:void 0};
Ua.prototype.has=function(a){var b=this.__data__;return Zb?void 0!==b[a]:Wl.call(b,a)};Ua.prototype.set=function(a,b){var c=this.__data__;this.size+=this.has(a)?0:1;c[a]=Zb&&void 0===b?"__lodash_hash_undefined__":b;return this};db.prototype.clear=function(){this.size=0;this.__data__={hash:new Ua,map:new (Rj||Ia),string:new Ua}};db.prototype["delete"]=function(a){a=jc(this,a)["delete"](a);this.size-=a?1:0;return a};db.prototype.get=function(a){return jc(this,a).get(a)};db.prototype.has=function(a){return jc(this,
a).has(a)};db.prototype.set=function(a,b){var c=jc(this,a),d=c.size;c.set(a,b);this.size+=c.size==d?0:1;return this};eb.prototype.clear=function(){this.__data__=new Ia;this.size=0};eb.prototype["delete"]=function(a){var b=this.__data__;a=b["delete"](a);this.size=b.size;return a};eb.prototype.get=function(a){return this.__data__.get(a)};eb.prototype.has=function(a){return this.__data__.has(a)};eb.prototype.set=function(a,b){var c=this.__data__;if(c instanceof Ia){var d=c.__data__;if(!Rj||199>d.length)return d.push([a,
b]),this.size=++c.size,this;c=this.__data__=new db(d)}c.set(a,b);this.size=c.size;return this};var kc=function(){try{var a=Dd(Object,"defineProperty");a({},"",{});return a}catch(b){}}(),yk=function(a){return function(b,c,d){var e=-1,g=Object(b);d=d(b);for(var h=d.length;h--;){var m=d[a?h:++e];if(!1===c(g[m],m,g))break}return b}}(),Li=Ka.Uint8Array,Sj=Object.create,Ck=function(){function a(){}return function(b){if(!Aa(b))return{};if(Sj)return Sj(b);a.prototype=b;b=new a;a.prototype=void 0;return b}}(),
Mi=function(a,b){return function(c){return a(b(c))}}(Object.getPrototypeOf,Object),sk=Object.prototype,Tj=Object.prototype,Xl=Tj.hasOwnProperty,Yl=Tj.propertyIsEnumerable,Jd=Ei(function(){return arguments}())?Ei:function(a){return fb(a)&&Xl.call(a,"callee")&&!Yl.call(a,"callee")},Id=Array.isArray,Uj="object"==typeof exports&&exports&&!exports.nodeType&&exports,Vj=Uj&&"object"==typeof module&&module&&!module.nodeType&&module,Wj=Vj&&Vj.exports===Uj?Ka.Buffer:void 0,Ii=(Wj?Wj.isBuffer:void 0)||tk,Ni=
...
Z["[object Map]"]=Z["[object Number]"]=Z["[object Object]"]=Z["[object RegExp]"]=Z["[object Set]"]=Z["[object String]"]=Z["[object WeakMap]"]=!1;var Xj="object"==typeof exports&&exports&&!exports.nodeType&&exports,$b=Xj&&"object"==typeof module&&module&&!module.nodeType&&module,ug=$b&&$b.exports===Xj&&Pj.process,Yj=function(){try{var a=$b&&$b.require&&$b.require("util").types;return a?a:ug&&ug.binding&&ug.binding("util")}catch(b){}}(),Zj=Yj&&Yj.isTypedArray,Ji=Zj?vk(Zj):uk,Bk=Object.prototype.hasOwnProperty,
...
b){return{bidCpmAdjustment:(c,d)=>{let e=this._config,g=e.video.instreamAdUnits.has(null===d||void 0===d?void 0:d.adUnitCode);c=Qd(e,c,b,d);g&&(c>e.video.vidDiscount?c-=e.video.vidDiscount:c=0);return c},inverseBidAdjustment:(c,d)=>{let e={mediaType:Object.keys(d.mediaTypes)[0],adUnitCode:d.adUnitCode},g=this._config,h=g.video.instreamAdUnits.has(null===e||void 0===e?void 0:e.adUnitCode)?g.video.vidDiscount:0;return Yi(g,d.bidder,e,c+h)},...a.settings}}};yg=l([p(),k("design:paramtypes",[y,W,Uc,Vc,
...
"bpto"}run(){return super.run()}};Cg=l([n("BidPoolingTimeoutExperiment"),p()],Cg);class Zc{get enabled(){return!0}}let $c=class extends Zc{constructor(a,b){var c;super();this._config=a;this._gam=b;this._localKey="_lr_env";this._isEnvelopeModuleReady=!1;this._enabled=(null===(c=this._config.liveRampAts)||void 0===c?void 0:c.enabled)&&"localStorage"in window;window.addEventListener("envelopeModuleReady",()=>{this._isEnvelopeModuleReady=!0})}get enabled(){return this._enabled}_runLiveRamp(a){var b,c;
let d,e="";this._config.gdpr.enabled?(d="gdpr",e=null!==(b=a.consent)&&void 0!==b?b:""):this._config.ccpa.required&&(d="ccpa",e=null!==(c=this._config.ccpa.privacyString)&&void 0!==c?c:this._config.ccpa.ccpaOptIn);try{window.atsenvelopemodule.setAdditionalData({consentString:e,...(void 0!==d?{consentType:d}:{}),id:a.hash?[a.hash]:a.email,type:a.hash?"emailHashes":"email"})}catch(g){r.error("LiveRampPiiPartner","processPii","Error setting ATS additional data",g)}}processPii(a){this._isEnvelopeModuleReady?
this._runLiveRamp(a):window.addEventListener("envelopeModuleReady",()=>{this._runLiveRamp(a)})}get _shouldSetTargeting(){return this._enabled&&!!H.getLocalStorageValue(this._localKey,!1)}};$c=l([n("LiveRampPiiPartner"),t(),k("design:paramtypes",[y,E])],$c);let sb=class extends Cj{constructor(a,b,c,d,e,g,h,m,q,w,u,v,A,G,L,J,D,P,M,ca,fa){super();this._bootstrapConfig=b;this._config=c;this._gam=d;this._s2s=e;this._bidderSetup=g;this._mediaType=h;this._prebidMethods=m;this._prebidConfiguration=q;this._predictiveAnalysisExperiment=
w;this._slots=u;this._creativeMonitoring=v;this._ortb2=A;this._oseq=G;this._gdprEnforcement=L;this._slotEventBus=J;this._userIdComponent=D;this._bidPoolingTimeoutExperiment=ca;this._liveRampPiiPartner=fa;this.videoAdUnits=[];this.bidsRequested=new z;this._isBeforeRequestEventLoaded=!1;this._excludedSlots=["Interstitial","Native_Recipe"];this._orderedDisplayBidders=this._bidderSetup.orderedDisplayBidders;this._orderedVideoBidders=this._bidderSetup.orderedVideoBidders;this._videoCreativeIdMapping=this._bidderSetup.videoCreativeIdMapping;
this._predictiveAnalysisResult=this._predictiveAnalysisExperiment.result;this._predictiveAnalysis=a.core.predictiveAnalysis;this._analytics=[P,M].filter(Oa=>Oa.enabled)}init(){let a=this._prebidConfiguration,b=this._orderedDisplayBidders;var c=this._orderedVideoBidders;c=[...b,...c];a.setDefaultConfig();a.aliasBidders(c);this._s2s.init();this._analytics.forEach(d=>void 0!==d.init&&d.init());b.forEach(d=>void 0!==d.init&&d.init());a.applyClientAndServerBidderSettings(c);mj().then(()=>this._prebidMethods.triggerUserSyncs()).then(()=>
this._registerSignalSources()).catch(d=>{r.error("PrebidAuctionManager","init","pageLoaded",d)});this._setEvents();this._predictiveAnalysisResult&&this._setVideoBidsFilter()}_logAuctionDebug(){this._prebidMethods.onEvent("auctionDebug",a=>{a&&"ERROR"===a.type&&([...a.arguments].some(b=>"string"===typeof b&&-1<b.indexOf("Error trying to write ad"))||r.error("PrebidAuctionManager","_logAuctionDebug","auctionDebug",a))})}async _registerSignalSources(){this._config.ccpa.userOptedOut||this._config.gdpr.enabled&&
!await this._gdprEnforcement.checkConsentForVendor(this._config.gdpr.cafeMediaVendorId,[1])||(this._prebidMethods.setConfig({userSync:{encryptedSignalSources:{sources:[{source:"esp.criteo.com id5-sync.com pubcid.org parrable.com liveramp.com liveintent.com uidapi.com".split(" "),encrypt:!1}],registerDelay:2E3}}}),this._prebidMethods.registerSignalSources())}_getNoBidReason(a,b){return Object.keys(a).length?"":b||"noBid"}_setEvents(){this._logAuctionDebug();this._creativeMonitoring.setupCreativeEventListeners();
this._prebidMethods.onEvent("bidWon",a=>{let b=this._slots.get(a.adUnitCode);b&&(b.servedPrebidBidResponse=a,this._slots.bidServed.emit(b))});this._prebidMethods.onEvent("auctionEnd",a=>{a.adUnits.forEach(b=>{let {code:c,noBidReason:d}=b;b=this._slots.get(c);let e=this._prebidMethods.getAdserverTargetingForAdUnitCode(b?b.id:c),g=this._getNoBidReason(e,d);b&&g?b.googleTagSlot.setTargeting("hb_bidder",g):this._slotEventBus.addPrebidSlotTargeting.emit({adUnitCode:c,slotTargeting:g?{noBid:g}:e})})});
...
c=this._liveRampPiiPartner._shouldSetTargeting?[...b,"ats"]:b;a.forEach(d=>{var e;const g=this._slots.get(d.code);d=null!==(e=d&&d.ortb2Imp&&d.ortb2Imp.ext&&d.ortb2Imp.ext.tid)&&void 0!==e?e:"";g&&(g.setTransactionId(d),g.setSlotTargetingFlag("tid",[g.transactionId],!0),g.setSlotTargetingFlag("idp",c,!0))});this._isBeforeRequestEventLoaded=!0});this._predictiveAnalysisResult&&this._setVideoBidsFilter();this._prebidMethods.onEvent("bidRequested",()=>{void this.bidsRequested.emit()});this._gam.slotOnload.on(({slot:a})=>
{if(a.bidPoolId){let b=this._bidPoolingTimeoutExperiment.result;setTimeout(()=>{this._prebidMethods.clearTargetingForSharedBidPool(a.id)},b&&1E3*b||0)}})}_setVideoBidsFilter(){if(this._predictiveAnalysis.length){var a=c=>{const d=this._config.context.device;return"1"===c?"phone"===d:"tablet"===d||"desktop"===d},b={};this._predictiveAnalysis.filter(c=>parseFloat(c.error_rate)>this._predictiveAnalysisResult&&"1"===c.chrome===Va()&&a(c.mobile)).forEach(c=>{b[`${c.adomain},${c.bidder}`]=!0});this._prebidMethods.setBidsReceivedFilter(c=>
c.length&&this._config.video.instreamAdUnits.has(c[0].adUnitCode)?c.filter(d=>{let e=!0,g=d.meta&&d.meta.advertiserDomains;if(!g||!Array.isArray(g))return e;g.forEach(h=>{b[h+","+d.bidder]&&(e=!1)});return e}):c)}}_updateSlotTargeting(a){if(this._mediaType.outstreamSlots.has(`${a.placementMapName}`)){var b=this._config.adTypes.enabledMinified.map(c=>c.toLowerCase()).filter(c=>"od"===c||"om"===c);b.length&&this._gam.setSlotTargeting({key:"hi_au",value:b},a.googleTagSlot)}}instlEnabled(a){return"Interstitial"===
a&&this._config.adOptions.interstitial.prebid}get videoCreativeIdMapping(){return this._videoCreativeIdMapping}addSlots(a){let b=this._orderedDisplayBidders.map(d=>d.getBidRequests(a)),c=a.filter(d=>this._shouldIncludeSlot(d)).sort((d,e)=>d.auctionPriority-e.auctionPriority).map(d=>{const e=this.instlEnabled(d.location),g=this._ortb2.addOrtb2Imp({slot:d},e);this._mediaType.oneStreamExpResult&&this._updateSlotTargeting(d);return{...(d.bidPoolId&&{bidPoolId:d.bidPoolId}),code:e?this._config.prebid.interstitialAdUnitCode:
d.element.id,mediaTypes:this._mediaType.getMediaType({slot:d}),...(g?{ortb2Imp:g}:{}),bids:b.map(h=>h.get(d.id)).filter(Cb).reduce((h,m)=>h.concat(m),[])}});this._prebidMethods.addAdUnits(c);this._setAdUnitOnSLot(a);return c}reset(){return this._prebidMethods.removeAllAdUnits()}_setAdUnitOnSLot(a){a.length&&this._prebidMethods.addToQueue(()=>{let b=this._prebidMethods.getPrebidAdUnits();b&&a.forEach(c=>{let d=b.filter(e=>e.code===c.element.id);d.length&&(c.prebidAdUnit=d[0])})})}_updateSlots(a){a.forEach(b=>
{b.isHighlyViewable()&&(this._updateBidderBidParams(b),this._updateAdUnitParams(b))})}_updateAdUnitParams(a){let b=a.prebidAdUnit;if(b){let c=this._ortb2.addOrtb2Imp({slot:a});b.ortb2Imp=c;b.mediaTypes=this._mediaType.getMediaType({slot:a})}}_updateBidderBidParams(a){let b=a.prebidAdUnit;b&&b.bids&&b.bids.forEach(c=>{let d=this._bidderSetup.biddersParams.get(c.bidder);d&&d.updateBidParams(c,a)})}_updateHighImpactUnitTargeting(){let a=this._gam;E.pushToQueue(()=>{let b=a.getTargetingValuesForKey("hi_au").filter(c=>
...
return b}_addHvpLabel(a,b){a.forEach(c=>{c.isHighlyViewable()&&b.push(`hvp_${c.placementMapName}`)})}_addRefreshLabel(a,b){a.forEach(c=>{0<c.refreshCount&&b.push("refresh")})}_addLabels(a,b){this._addRefreshLabel(a,b);this._addOutstreamLabel(a,b);this._addHvpLabel(a,b)}requestBids(a,b=this._config.timeouts.initialBidsRequest,c=[]){a=a.filter(d=>this._shouldIncludeSlot(d));return new Promise(d=>{this.checkLibLoaded().then(e=>{if(e&&a.length){var g=a.map(h=>this.instlEnabled(h.location)?this._config.prebid.interstitialAdUnitCode:
h.element.id);this._addLabels(a,c);this._updateSlots(a);this._prebidMethods.requestBids({adUnitCodes:g,timeout:b,bidsBackHandler:()=>{E.pushToQueue(()=>{this._prebidMethods.setTargetingForGPTAsync(g,null,a[0].bidPoolId,1);d()})},labels:c})}else d()}).catch(e=>r.error("PrebidAuctionManager","requestBids",e))})}addVideoSlots(a){let b=this._orderedVideoBidders.map(d=>d.getVideoBidRequests(a)),c=a.map(d=>{var e=this._ortb2.addOrtb2Imp({video:d});e={code:d.name,ortb2Imp:e,mediaTypes:this._mediaType.getMediaType({video:d}),
bids:b.map(g=>g.get(d.name)).filter(Cb).reduce((g,h)=>g.concat(h),[])};return d.videoAdUnit=e});this._prebidMethods.addAdUnits(c)}requestVideoBids(a,b=this._config.timeouts.initialBidsRequest){let c=a.map(({name:d})=>d);return new Promise(d=>{this.checkLibLoaded().then(e=>{e||d();this._prebidMethods.requestBids({adUnitCodes:c,timeout:b,bidsBackHandler:()=>{E.pushToQueue(()=>{this._prebidMethods.setTargetingForGPTAsync(c);d()})}})}).catch(e=>r.error("PrebidAuctionManager","requestVideoBids",e))})}refreshBids(a){return this.requestBids(a,
this._config.timeouts.refreshBidsRequest)}checkLibLoaded(){return new Promise(a=>{this._bootstrapConfig.bootstrapLoaders[ra.Prebid].then(()=>a(!0)).catch(()=>a(!1))})}get enabled(){return!/Trident|MSIE/.test(ha)}};sb=l([n("PrebidAuctionManager"),p(),U(0,T("AdThrive")),k("design:paramtypes",[Object,ma,y,E,Bg,og,za,W,yg,Xc,la,qg,ac,vg,qb,Ha,Qc,Ef,Ff,Cg,$c])],sb);let tb=class{constructor(a,b,c,d){this._slotEventBus=c;this._videoEventBus=d;this._auctionManagers=[b,a];this._auctionManagers=this._auctionManagers.filter(e=>
e.enabled);this._setSlotEvents();this._setVideoEvents()}_setSlotEvents(){this._slotEventBus.addSlots.on(a=>this._addSlots(a));this._slotEventBus.requestingBids.on(a=>this._requestBids(a));this._slotEventBus.refreshingBids.on(a=>this._refreshBids(a))}_setVideoEvents(){this._videoEventBus.videoPlayerAdded.on(a=>this._addVideoSlots(a));this._videoEventBus.requestingVideoBids.on(({videos:a,timeout:b})=>this._requestVideoBids(a,b))}init(){this._auctionManagers.forEach(a=>void 0!==a.init&&a.init())}_requestBids(a){return Promise.all(this._auctionManagers.map(b=>
b.requestBids(a)))}_refreshBids(a){return Promise.all(this._auctionManagers.map(b=>b.refreshBids(a)))}_addSlots(a){this._auctionManagers.forEach(b=>{void 0!==b.addSlots&&b.addSlots(a)})}_addVideoSlots(a){this._auctionManagers.filter(b=>b.videoEnabled&&b.addVideoSlots).forEach(b=>b.addVideoSlots(a))}_requestVideoBids(a,b){return Promise.all(this._auctionManagers.filter(c=>c.videoEnabled).map(c=>c.requestVideoBids(a,b)))}getPrebidAuctionManager(){for(let a of this._auctionManagers)if(a instanceof sb)return a}getAmazonAuctionManager(){for(let a of this._auctionManagers)if(a instanceof
Pc)return a}};tb=l([n("AuctionManagers"),p(),k("design:paramtypes",[sb,Pc,Ha,Ca])],tb);let Dg=class{constructor(a){this._commands=a.cmd||[]}init(){if(0<this._commands.length){for(let a of this._commands)this._isGamMethod(a.toString())?this._addToGamQueue(a):this._call(a);this._commands=[]}}push(a){0<this._commands.length?this._commands.push(a):this._isGamMethod(a.toString())?this._addToGamQueue(a):this._call(a)}_call(a){a.call(void 0)}_isGamMethod(a){return a&&(a.includes("setTargeting(")||a.includes("googletag")||
a.includes("pubads"))}_addToGamQueue(a){E.pushToQueue(()=>{this._call(a)})}};Dg=l([p(),U(0,T("AdThrive")),k("design:paramtypes",[Object])],Dg);let ad=class{constructor(){this.wasStarted=this.wasClosed=!1;this.totalTimeCollapsed=0}};ad=l([n("CollapsibleVideoLoggingStore"),p()],ad);let Eg=class extends K{constructor(a,b){super();this._result=!1;this.key="upl";this._choices=[{choice:!0},{choice:!1}];this.weight=.25;if(b=b.getCoreExperimentButMutateWeights(this.key))this.weight=b.variants[0].weight,this._result=
this.run(),a.set(this.key,this._result?"on":"off")}get result(){return this._result}run(){return(new O(this.weight)).get()}};Eg=l([n("UserPageDataLoggingExperiment"),p(),k("design:paramtypes",[I,aa])],Eg);let Fg=class extends K{constructor(a){super();this._result=!1;this.key="UserPageDataPrivacyLoggingExperiment";this._choices=[{choice:!0},{choice:!1}];this.weight=.1;if(a=a.getCoreExperimentButMutateWeights(this.key))this.weight=a.variants[0].weight,this._result=this.run()}get result(){return this._result}run(){return(new O(this.weight)).get()}};
Fg=l([n("UserPageDataPrivacyLoggingExperiment"),p(),k("design:paramtypes",[aa])],Fg);let Gg=class extends C{constructor(a,b,c,d,e,g,h,m,q,w){super();this._bootstrapConfig=a;this._config=b;this._pageManager=c;this._spaEventBus=d;this._prebidMethods=e;this._slotManager=g;this._userPageDataLoggingExperiment=h;this._userPageDataPrivacyLoggingExperiment=m;this._userPageDataLogEvents=q;this._collapsibleVideoLoggingStore=w;this._userPrivacyData={};this._setupSlotManagerEventListeners=()=>{let {reasons:u}=
this._config.disableAds,v={requestingBids:null,requestedBids:null,displayed:null},A={...v,pageLoaded:!1},G=(L,J)=>{A[L]=J;"number"===typeof A.requestingBids&&"number"===typeof A.requestedBids&&"number"===typeof A.displayed&&A.pageLoaded&&(this._setTimingData(A.requestingBids,A.requestedBids,A.displayed),A={...A,...v})};0!==u.size?(A.requestedBids=0,A.requestingBids=0,A.displayed=0):(this._slotManager.requestingBids.once(()=>G("requestingBids",ia())),this._slotManager.requestedBids.once(()=>G("requestedBids",
ia())),this._slotManager.displayed.once(()=>G("displayed",ia())));mj().then(()=>G("pageLoaded",!0))};this._setupUserPageDataLogEventCallbacks=()=>{Q()&&this._userPageDataLogEvents.addCallbackToQueue([this._pageManager.visibilityChange],()=>{"hidden"===document.visibilityState&&this._logUserData()});this._userPageDataLogEvents.addCallbackToQueue([this._pageManager.beforeUnload,this._pageManager.pageHide],()=>this._logUserData());this._spaEventBus.routeChanged.on(()=>this._logUserData())};this._getUserData=
()=>{let u=this._getBuildData();var v=this._config.context.device,A=googletag&&googletag.getVersion&&googletag.getVersion(),G=ia()-this._config.timing.started,L=this._config.timing.totalTimeOnPage,J=window.innerWidth,D=window.innerHeight,P={nonclose:!this._collapsibleVideoLoggingStore.wasClosed,playerName:this._collapsibleVideoLoggingStore.playerName,totalTimeCollapsed:this._collapsibleVideoLoggingStore.totalTimeCollapsed,wasStarted:this._collapsibleVideoLoggingStore.wasStarted},M={...this._userPrivacyData},
ca;if(ca=!this._config.gdpr.enabled&&!this._config.ccpa.userOptedOut){a:{if(this._prebidMethods.isPrebidLoaded())for(const fa of window.pbjs.getUserIdsAsEids())if(fa.source&&"adserver.org"===fa.source&&fa.uids&&0<fa.uids.length&&fa.uids[0].id){ca=fa.uids[0].id;break a}ca=null}ca={uid1:ca}}return{...u,device:v,gptv:A,timePageOpen:G,timeOnPage:L,viewportWidth:J,viewportHeight:D,video:P,...M,...ca}}}init(){this._setupSlotManagerEventListeners();this._setupUserPageDataLogEventCallbacks();this._logUserPrivacyData().catch(()=>
{r.error("_logUserPrivacyData: ","Could not log user privacy.")})}get enabled(){return this._userPageDataLoggingExperiment.result}_getBuildData(){var a=window.adthriveCLS;a=a&&a.buildDate;return{bundleBuildDate:window.adthrive.buildDate,...(a?{clsBuildDate:a}:{})}}_setTimingData(a,b,c){if(window.performance&&window.performance.timing){var d=window.performance.timing;if(d&&0!==d.navigationStart){let e={pageLoad:d.loadEventStart-d.navigationStart,domainLookup:d.domainLookupEnd-d.domainLookupStart,connect:d.connectEnd-
d.connectStart,request:d.responseStart-d.requestStart,response:d.responseEnd-d.responseStart,navigation:d.fetchStart-d.navigationStart,domInteractive:d.domInteractive-d.navigationStart,domContentLoaded:d.domContentLoadedEventStart-d.navigationStart};Object.keys(e).map(g=>e[g]).every(g=>!isNaN(g)&&0<=g&&36E5>g)&&(this._setNonBlockingLibraryTimingData(),{reasons:d}=this._config.disableAds,this._timingData={...e,...this._config.timing.timingData,disableAds:0<d.size?[...d].join():"none",auctionStarted:a,
auctionFinished:b,displayed:c})}}}_setNonBlockingLibraryTimingData(){this._config.timing.setNonBlockingLibraryTimingData(this._bootstrapConfig.bootstrapResult)}_logUserData(){this._userPageDataLogEvents.loggingData.emit();this._userPageDataLogEvents.setUserPageData({...(this._timingData&&{UserPageTimingData:this._timingData}),UserPageDataLoggingComponent:this._getUserData()})}async _logUserPrivacyData(){this._userPageDataPrivacyLoggingExperiment.result&&(this._userPrivacyData=await this._getUserPrivacyData())}async _getUserPrivacyData(){return{gpc:"navigator"in
window&&"globalPrivacyControl"in window.navigator?window.navigator.globalPrivacyControl:null,dcp:await this._getDataConsent()}}async _getDataConsent(){if("dataConsentPreference"in document)try{return await document.dataConsentPreference()}catch(a){}return null}};Gg=l([n("UserPageDataLoggingComponent"),t(),k("design:paramtypes",[ma,y,wa,ka,W,V,Eg,Fg,lb,ad])],Gg);class bm{constructor(){this._map=[]}add(a,b,c,d=document){this._map.push({el:a,coords:b,dynamicAd:c,target:d})}get map(){return this._map}sort(){this._map.sort(({coords:a},
{coords:b})=>a-b)}filterUsed(){this._map=this._map.filter(({dynamicAd:a})=>!a.used)}reset(){this._map=[]}}let bb=class extends bm{};bb=l([p()],bb);let Hg=class extends K{constructor(a){super();this._result=!1;this.key="AdDensityExperiment";this._choices=[{choice:!0},{choice:!1}];this.weight=.25;if(a=a.getCoreExperimentButMutateWeights(this.key))this.weight=a.variants[0].weight,this._result=this.run()}get result(){return this._result}run(){return(new O(this.weight)).get()}};Hg=l([n("RealizedAdDensityExperiment"),
p(),k("design:paramtypes",[aa])],Hg);let Ig=class extends C{constructor(a,b,c,d,e,g,h,m){super();this._gam=a;this._config=b;this._realizedAdDensityExperiment=c;this._slots=d;this._slotManager=e;this._pageManager=g;this._userPageDataLogEvents=h;this._adInjectionMap=m;this._initialSlotsTimeout=1E4;this._addToMainContent=new Set(["Below_Post"]);this._slotsForAdDensity=new Set("Content Recipe Native_Recipe Sponsor_Tile Below_Post Footer".split(" "));this._commentElem=this._mainContent=null;this._heightsRegistered=
!1;this._slotsHeightVideo=this._slotsHeightEnd=this._slotsHeightLoad=this._endMainContentHeight=this._initMainContentHeight=null;this._slotsForInitial=new Set;this._slotsForMainContent=new Set;this._slotsForEnd=new Set}init(){let [a]=fj(this._config.dynamicAds,this._adInjectionMap);this._mainContent=a;null!==this._mainContent&&(this._initObserver(this._mainContent),this._gam.slotOnload.on(()=>{this._heightsRegistered||(setTimeout(()=>{this._getSlotHeights()},this._initialSlotsTimeout),this._heightsRegistered=
!0)}),this._slotManager.added.on(b=>{b.some(c=>c.infinite)||this._addSlots(b)}),this._userPageDataLogEvents.addCallbackToQueue([this._pageManager.beforeUnload],()=>this._logAdDensity()))}_logAdDensity(){let a={...(this._initMainContentHeight&&this._slotsHeightLoad&&{addensload:Math.round(this._slotsHeightLoad/this._initMainContentHeight*100)}),...(this._endMainContentHeight&&this._slotsHeightEnd&&{addensend:Math.round(this._slotsHeightEnd/this._endMainContentHeight*100)}),...(this._endMainContentHeight&&
this._slotsHeightVideo&&{addensvid:Math.round(this._slotsHeightVideo/this._endMainContentHeight*100)})};0<Object.keys(a).length&&this._userPageDataLogEvents.setUserPageData({AdDensityComponent:a})}_addSlots(a){a.filter(b=>this._slotsForAdDensity.has(b.location)).filter(b=>!b.element.classList.contains("adthrive-slicksearch")).forEach(b=>{b.lazy||(this._slotsForInitial.add(b.name),this._addToMainContent.has(b.location)&&this._slotsForMainContent.add(b.name));this._slotsForEnd.add(b.name)})}isSlotInMainContent(a){var b;
return(null===(b=this._mainContent)||void 0===b?0:b.querySelector(`#${a.id}`))&&!this.isSlotInComment(a)?!0:!1}isSlotInComment(a){return this._commentElem&&this._commentElem.querySelector(`#${a.id}`)?!0:!1}_getSlotHeights(){let a=0,b=0;this._slots.get().forEach(c=>{this._slotsForInitial.has(c.name)&&("Content"!==c.location||this.isSlotInMainContent(c))&&(a+=c.element.offsetHeight);this._slotsForMainContent.has(c.name)&&(b+=c.element.offsetHeight)});this._slotsHeightLoad=a;this._mainContent&&(this._initMainContentHeight=
Vd(this._mainContent),this._initMainContentHeight+=b)}_initObserver(a){let b=a.querySelector("div #comments, section .comments");this._observer=this.getIntersectionObserver(b);null!==b?(this._commentElem=b,this._observer.observe(this._commentElem)):this._observer.observe(a)}getIntersectionObserver(a){return new IntersectionObserver(b=>{var c,d;for(const e of b)null!==this._initMainContentHeight&&(null===a&&0>e.boundingClientRect.top&&(this._calculateSlotHeightsAtEnd(),null===(c=this._observer)||void 0===
c?void 0:c.unobserve(this._mainContent)),null!==a&&0<e.boundingClientRect.top&&(this._calculateSlotHeightsAtEnd(),null===(d=this._observer)||void 0===d?void 0:d.unobserve(a)))},{})}_calculateSlotHeightsAtEnd(){let a=0,b=0;this._slots.get().forEach(c=>{this._slotsForEnd.has(c.name)&&("Content"!==c.location||this.isSlotInMainContent(c))&&(a+=c.element.offsetHeight);this._slotsForMainContent.has(c.name)&&(b+=c.element.offsetHeight)});this._slotsHeightEnd=a;this._mainContent&&(this._endMainContentHeight=
Vd(this._mainContent),this._endMainContentHeight+=b);if(this._config.video.playlistPlayerAdded){let c=document.querySelector(".adthrive-collapse-player");a+=c?c.offsetHeight:0}this._config.video.contextualPlayerAdded&&document.querySelectorAll(".adthrive-video-player").forEach(c=>{a+=c.offsetHeight});this._slotsHeightVideo=a}get enabled(){return this._realizedAdDensityExperiment.result&&"IntersectionObserver"in window&&!(null!==document.querySelector("body.home")||null!==document.querySelector("body.archive"))&&
window.location.origin+"/"!==window.location.href.split("?")[0]}};Ig=l([n("RealizedAdDensityComponent"),t(),k("design:paramtypes",[E,y,Hg,la,V,wa,lb,bb])],Ig);let Jg=class extends C{constructor(a,b){super();this._config=a;this._gam=b}init(){if(this._config.context.querystring.has("ad_test")){let a=this._config.context.querystring.get("ad_test");this._gam.setTargeting({key:"sec",value:a.split(",").map(b=>`test${b}`)})}}};Jg=l([n("AdTestComponent"),t(),k("design:paramtypes",[y,E])],Jg);let Kg=class extends C{constructor(a,
b,c){super();this._config=a;this._piiEventBus=b;this._amazonMethods=c;this._trackerHoldoutKey="amz";this._tokenKey="AMZN-Token";this._gdprEnabled=this._config.gdpr.enabled;this._userOptedOut=this._config.ccpa.userOptedOut}init(){this._regulatoryValidation();this._piiEventBus.dataCaptured.on(a=>this._provideEmailCapture(a))}get enabled(){return this._config.tkho.tracker!==this._trackerHoldoutKey}_provideEmailCapture(a){a={...this._getHashedRecords(a.hash),...this._getGDPRConfig(a.consent),...this._getOptOut()};
this._amazonMethods.rpa(a)}_getHashedRecords(a=""){return{hashedRecords:[{type:"email",record:a}]}}_getGDPRConfig(a){let b=this._gdprEnabled;return{gdpr:{enabled:b,...(b&&{consent:a})}}}_getOptOut(){return{optOut:this._userOptedOut}}_regulatoryValidation(){Ba(this._tokenKey)&&this._userOptedOut&&this._optOut()}_optOut(){this._amazonMethods.upa({hashedRecords:[],optOut:!0})}};Kg=l([n("AmazonPublisherAudiences"),t(),k("design:paramtypes",[y,Xa,Cf])],Kg);let Lg=class extends K{constructor(a,b){super();
...
"Information from your device can be used to personalize your ad experience. <br><br>");this.ccpaOptOutDiv.style.display=a?"block":"none";this.ccpaOptOutDiv.appendChild(this.ccpaATag);this.setCCPAEventListener(!0,!1,this.ccpaATag);this.createCCPAModal();this.createModalLowerButtons()}deleteData(){}setDeviceAccess(){this._deviceAccess=this.privacyString===this.ccpaOptIn?!0:!1}}let bd=class extends ea{init(){let a=F.resolve(y);this._key="spa_"+String(a.site.id);this._default=!1}};bd=l([n("SpaMultiSiteExperiment"),
p()],bd);let ub=class extends ea{init(){let a=F.resolve(bd).key;this._key=this._coreExperimentConfig.getCoreExperiment(F.resolve(bd).key)?a:"spa";this._default=!1}isEnabled(){return!0===F.resolve(y).adOptions.spa&&super.isEnabled()}run(){return super.run()}};l([N(),k("design:type",Function),k("design:paramtypes",[]),k("design:returntype",Object)],ub.prototype,"run",null);ub=l([n("SinglePageAppManagerExperiment"),p()],ub);let cd=class extends cm{constructor(a,b,c){super(a);this._singlePageAppManagerExperimentResult=
...
{this.init();let a=document.querySelector(`#${this.ccpaOptOutDivId}`),b=this._isHomeOrFPV()?"block":"none";a&&(a.style.display=b)})}injectFooter(){this.ccpaOptOutDiv&&this._config.footer.elements.push({order:1,element:this.ccpaOptOutDiv})}};cd=l([n("CCPAComponent"),t(),k("design:paramtypes",[y,ka,ub])],cd);let dd=class extends K{constructor(a,b){super();this._result=!1;this.key="confiant1";this._choices=[{choice:!0},{choice:!1}];this.weight=.01;if(b=b.getCoreExperimentButMutateWeights(this.key))this.weight=
b.variants[0].weight,this._result=this.run(),a.set(this.key,this._result?"exp":"prod")}get result(){return this._result}run(){return(new O(this.weight)).get()}};l([N(),k("design:type",Function),k("design:paramtypes",[]),k("design:returntype",void 0)],dd.prototype,"run",null);dd=l([n("ConfiantPropertyExperiment"),p(),k("design:paramtypes",[I,aa])],dd);let dm=new Map([[1,{type:"manual",description:"Deprecated"}],[2,{type:"creative",description:"Creative-based detection"}],[3,{type:"provider_security",
...
void 0)],fd.prototype,"run",null);fd=l([p(),U(3,T("AdthriveCLS")),k("design:paramtypes",[Da,ya,Hb,Object])],fd);class Sg{constructor(a){this._adInjectionMap=a;this._mainContentHeight=this._recipeCount=0;this._mainContentDiv=null;this._totalAvailableElements=[];this._densityDevice=Ab.Desktop;this._pubLog={onePerViewport:!1,targetDensity:0,targetDensityUnits:0,combinedMax:0};this._densityMax=.99;this._smallerIncrementAttempts=0;this._absoluteMinimumSpacingByDevice=250;this._usedAbsoluteMinimum=!1;this.locationMaxLazySequence=
new Map([["Recipe",5]]);this._stickyContainerAdsExperiment=F.resolve(ed);this._stickyContainerRecipeExperiment=F.resolve(rb)}inject(a,b=document){window.adthriveCLS&&window.adthriveCLS.targetDensityLog&&r.event("BaseDynamicAdsInjector","_logDensityInfo",window.adthriveCLS.targetDensityLog);this._densityDevice="desktop"===this._config.context.device?Ab.Desktop:Ab.Mobile;this._overrideDefaultAdDensitySettingsWithSiteExperiment();let c=this._config.targetDensity.enabled;var d=a.filter(e=>c?"Content"!==
e.location:e);a=a.filter(e=>c?"Content"===e.location:null);d=d.length?this._injectNonDensitySlots(d,b):[];b=a.length?this._injectDensitySlots(a,b):[];return[...d,...b]}_injectNonDensitySlots(a,b=document){let c=[];for(let m of a){let q=a=0,w=0;0<m.spacing&&(q=a=window.innerHeight*m.spacing);let u=this._repeatDynamicAds(m),v=this._getElements(m.elementSelector,b);for(let A=m.skip;A<v.length&&!(w+1>u.length);A+=m.every){var d=v[A];if(0<a){var {bottom:e}=Ud(d);if(e<=q)continue;q=e+a}e=u[w];let G=`${e.location}_${e.sequence}`;
...
this.start()})}_added(){this._footerConfigEventBus.footerElementAdded.on(a=>{this._config.footer.elements.push(a)},{handleEventsAlreadyEmitted:!0})}};eh=l([n("FooterComponent"),t(),k("design:paramtypes",[y,ka,Db])],eh);let em={"000000":"A","000001":"B","000010":"C","000011":"D","000100":"E","000101":"F","000110":"G","000111":"H","001000":"I","001001":"J","001010":"K","001011":"L","001100":"M","001101":"N","001110":"O","001111":"P","010000":"Q","010001":"R","010010":"S","010011":"T","010100":"U","010101":"V",
"010110":"W","010111":"X","011000":"Y","011001":"Z","011010":"a","011011":"b","011100":"c","011101":"d","011110":"e","011111":"f",1E5:"g",100001:"h",100010:"i",100011:"j",100100:"k",100101:"l",100110:"m",100111:"n",101E3:"o",101001:"p",101010:"q",101011:"r",101100:"s",101101:"t",101110:"u",101111:"v",11E4:"w",110001:"x",110010:"y",110011:"z",110100:"0",110101:"1",110110:"2",110111:"3",111E3:"4",111001:"5",111010:"6",111011:"7",111100:"8",111101:"9",111110:"-",111111:"_"},id=class extends C{constructor(a,
...
b(this._getField(c),!0):this._getField(c);case "getGPPData":return d?b(this._getGPPData()):this._getGPPData()}}get enabled(){return"US"===this._config.context.country}};id=l([n("GPPComponent"),t(),k("design:paramtypes",[y,cd,ac,ka])],id);let fh=class extends C{constructor(a,b){super();this._slotManager=a;this._slots=b}init(){let a=!1;this._slots.bidServed.on(b=>{b.servedPrebidBidResponse&&"gumgum"===b.servedPrebidBidResponse.bidder&&"Footer"===b.location&&(a=!0)});this._slotManager.refreshing.on(b=>
...
data:{message:c.message}})}}};gh=l([n("IdentityAPIComponent"),t(),k("design:paramtypes",[Wb,y,qb])],gh);let hh=class extends ea{init(){this._key="jtte";this._default=!1}};hh=l([p()],hh);var jd;(function(a){a.Recipe="Recipe";a.Video="Video"})(jd||(jd={}));class ak{constructor(){this._elements=[];this._hasFired=!1;this._buttonClicked=this._processButtonClicked.bind(this)}init(){this._addElementListeners()}_processButtonClicked(a){this._hasFired||this._logEvent(a.target.classList);this._cleanup()}_logEvent(a){r.event("JumpToTracker",
"_logEvent",this.trackerType.toLowerCase(),a)}_cleanup(){for(let a of this._elements)a.removeEventListener("click",this._buttonClicked)}_addElementListeners(){this.setElements()}setElements(){this._elements=Array.prototype.slice.call(document.querySelectorAll(this.selectors.join()));for(let a of this._elements)a.addEventListener("click",this._buttonClicked)}}let ih=class extends ak{constructor(){super();this.trackerType=jd.Recipe;this.selectors=".wprm-recipe-jump #jump-to-recipe #wprm-jump .wprm-jump .tasty-recipes-jump-link .mv-create-jtr .jump-to-recipe".split(" ");
this.init()}};ih=l([t(),k("design:paramtypes",[])],ih);let jh=class extends ak{constructor(){super();this.trackerType=jd.Video;this.selectors=[".wprm-recipe-jump-video"];this.init()}};jh=l([t(),k("design:paramtypes",[])],jh);let kh=class extends C{constructor(a){super();this._jumpToTrackerExperiment=a}start(){F.resolve(ih);F.resolve(jh)}get enabled(){return this._jumpToTrackerExperiment.result}};kh=l([t(),n("JumpToTrackerComponent"),k("design:paramtypes",[hh])],kh);let lh=class extends C{constructor(a,
...
Wa(a.split("?")[1]);return{custParams:this._getDecodedURI(a.get("cust_params")||""),iu:a.get("iu")||"",sz:this._sizeStringToArray(a.get("sz"))||[1,1]}}_sizeStringToArray(a){if(a)return a.split("x").map(b=>parseInt(b))}_bannerSlotRenderEnded({event:a,slot:b}){let c=a.slot.getAdUnitPath(),d=jb();this._renderedSlotKey.set(c,d);a={adUnitPath:c,advertiserId:a.advertiserId,agnosticCreativeId:a.sourceAgnosticCreativeId,agnosticLineItemId:a.sourceAgnosticLineItemId,campaignId:a.campaignId,companyIds:a.companyIds,
...
slotElementId:a.adUnitName,slotKey:jb(),slotTargeting:this._filterTargeting(nj(b.custParams))};this._logImpressionEvent(a)}_filterTargeting(a){return Object.keys(a).filter(b=>!this._filterKeys.has(b)&&a[b].length).reduce((b,c)=>{b[c]=a[c];return b},{})}_logImpressionEvent(a){r.event("SlotRenderEnded","adImpression",a)}};lh=l([n("ImpressionLogComponent"),t(),k("design:paramtypes",[y,E,Qa])],lh);let mh=class extends C{constructor(a,b,c){super();this._googleAdManager=a;this._config=b;this._slotManager=
...
(this._element.classList.remove(this._stickyClass),this._stuck=!1)}getTop(a){return a.getBoundingClientRect().top+window.pageYOffset}findOverlap(a){let b=null;for(;a.parentElement;){a=a.parentElement;let c=a.nextElementSibling;for(;c&&!Yd(c);)c=c.nextElementSibling;c&&0<c.offsetTop&&(!b||c.offsetTop<b.offsetTop)&&(b=c)}return b}}let kd=class{constructor(a){this.config=a;this._headerVisibleEvents=[];this._headerHiddenEvents=[];this._header=null;this._isHeaderVisible=!0;this.handleUncollapse=()=>{};
...
this._headerHiddenEvents.push(e)}getHeaderHeight(a){return(a=this.siteHeader(a))?this.getElementHeight(a):null}getElementHeight(a){return a.getBoundingClientRect().height}siteHeader(a){if(this._header)return this._header;a=document.querySelector(a);if(!a)return null;this._header=a;this.collapsiblePersistentHeaderObserver.observe(this._header);return this._header}};kd=l([p(),n("TopCenterVideoPlayerForPersistentHeadersUtils"),k("design:paramtypes",[y])],kd);var Sa;let ba=Sa=class{static changeState(a,
...
a);break;case 9:this._handleNonLinearAdPaused(b,a);break;case 6:this._handleOverlapped(b,h,a);break;case 10:this._handleNonLinearAdOverlapped(b,h,a)}return a.playerState}static _handleUnstarted(a,b,c){let d=c.playerInstance;4===a&&(c.collapseTimer.firstInView||(c.collapseTimer.firstInView=new Date),Sa.startEvent.emit(),b?(this.collapse(c),d.getViewable()&&d.play(!0),c.playerState=d._nonLinearAd?8:2):c.playerState=d._nonLinearAd?8:1)}static _setPlayerClosed(a){a.playerState=7;a.collapseMobileSubType&&
...
b){a.topBackgroundElement&&(a.topBackgroundElement.style.height=b?`${a.playerElement.offsetHeight}px`:"0")}static repositionCollapseMobileBottom(a){if(a.playerElement.className.includes("adthrive-collapse-bottom")||a.collapseMobileSubType&&-1<a.collapseMobileSubType.indexOf("bottom")){let b=Td();a.playerElement.style.setProperty("top","auto","important");a.playerElement.style.setProperty("bottom",`${b}px`,"important")}}static resizeContainer(a){a.playerContainer.style.height=`${a.playerElement.offsetHeight+
...
new z;ba.closeEvent=new z;ba.startEvent=new z;ba.viewableEvent=new z;ba.visibleEvent=new z;ba.disableCollapse=!1;ba=Sa=l([n("CollapseUtils")],ba);let ld=class extends ea{init(){let a=F.resolve(y);this._key="sotc_"+String(a.site.id);this._default=!1}};ld=l([n("StickyOutstreamTopCenterMultiSiteExperiment"),p()],ld);let nh=class extends ea{init(){let a=F.resolve(ld).key;this._key=this._coreExperimentConfig.getCoreExperiment(F.resolve(ld).key)?a:"sotc";this._default=!1}};nh=l([n("StickyOutstreamTopCenterExperiment"),
...
()=>{}),b||g.push({hash:null!==(e=a.hash)&&void 0!==e?e:""}))}};rh=l([n("LiveIntentComponent"),t(),k("design:paramtypes",[y,Xa,Pa,W])],rh);let sh=class extends C{constructor(a){super();this._slotManager=a}init(){this._slotManager.added.on(a=>{E.pushToQueue(()=>{for(let b of a){let c=ej(b)||0;b.hvp=c;50<=c&&b.setTargeting({key:"hvp",value:c.toString()})}})});this._slotManager.refreshing.on(a=>{E.pushToQueue(()=>{for(let b of a)if(2>=b.refreshCount&&(!b.hvp||80>b.hvp)){let c=dj(b)||0;b.hvp=c;60<=c&&
...
{r.error("MarmaladeComponent","init",b)}))}_addFlpMessaging(){let a=this._config.marmalade.flpProdIds.filter(La);a&&kl(/https:\/\/\S*\.safeframe.googlesyndication.com/i,{message:"adthriveFlippData",flippData:a})}get enabled(){return!this._config.disableAds.all}};uh=l([n("MarmaladeComponent"),t(),k("design:paramtypes",[y,th,V,E,W,Ga])],uh);let vh=class extends C{constructor(a,b,c){super();this._config=a;this._gam=b;this._topicsApiIframeManager=c}get enabled(){return this._topicsApiIframeManager.enabled}init(){this._config.context.fledgeSupported&&
...
[Wb,$a,y,E,Xa])],wh);let xh=class extends Zc{constructor(a,b,c){super();this._config=a;this._prebidMethods=b;this._userIds=c;this._submitted=!1;this.userId=c.get("connectId").id}get enabled(){return this._userIds.get("connectId").enabled}updateUserIds(){return this._prebidMethods.getConfig("userSync.userIds").map(a=>{a.name===this.userId.name&&(a=this.userId);return a})}processPii(a){this._prebidMethods.addToQueue(()=>{this.run(a)})}run(a){a.hash&&this.userId.params&&!this._submitted&&(this.userId.params.he=
a.hash,this._submitted=!0,a=this.updateUserIds(),this._prebidMethods.setConfig({userSync:{userIds:a}}),this._prebidMethods.refreshUserIds({submoduleNames:[this.userId.name]},()=>{}))}};xh=l([n("YahooPiiPartner"),t(),k("design:paramtypes",[y,W,Pa])],xh);let yh=class extends Zc{constructor(a,b){super();this._prebidMethods=a;this._userIds=b;this._userId=b.get("id5Id").id}get enabled(){return this._userIds.get("id5Id").enabled}processPii(a){this._prebidMethods.addToQueue(()=>{this.run(a)})}updateUserIds(){return this._prebidMethods.getConfig("userSync.userIds").map(a=>
{a.name===this._userId.name&&(a=this._userId);return a})}run(a){if(a.hash&&this._userId.params){this._userId.params.he=a.hash;let b=this.updateUserIds();a.hash&&this._userIds.sharedIdValue&&(a=btoa(`1=${a.hash}&5=${this._userIds.sharedIdValue}&12=${ha}`),this._userId.params.pd=a);this._prebidMethods.setConfig({userSync:{userIds:b}});this._prebidMethods.refreshUserIds({submoduleNames:[this._userId.name]},()=>{})}}};yh=l([t(),n("Id5PiiPartner"),k("design:paramtypes",[W,Pa])],yh);let zh=class extends Zc{constructor(a,
b,c){super();this._config=a;this._prebidMethods=b;this._userIds=c}get enabled(){let a=this._config.partners;return!(!a.display.get(f.Criteo)&&!a.video.get(f.Criteo))}processPii(a){this._prebidMethods.addToQueue(()=>{this.run(a)})}run(a){a.hash&&this._prebidMethods.setBidderConfig({bidders:[f.Criteo],config:{ortb2:{user:{ext:{data:{eids:[{source:"cafemedia.com",uids:[{id:a.hash,atype:3,ext:{stype:"hemsha256"}}]}]}}}}}})}};zh=l([t(),n("CriteoBidderPiiPartner"),k("design:paramtypes",[y,W,Pa])],zh);let Ah=
class extends C{constructor(a,b,c,d,e,g){super();this._piiManager=a;this._piiEventBus=b;this._partners=[c,d,e,g].filter(h=>h.enabled);this._piiEventBus.dataCaptured.on(h=>{this._partners.forEach(m=>{m.processPii(h)})})}start(){this._partners.forEach(a=>a.init&&a.init());this._piiManager.init()}};Ah=l([n("PiiCaptureComponent"),t(),k("design:paramtypes",[wh,Xa,$c,xh,yh,zh])],Ah);let Bh=class extends C{constructor(a){super();this._slotManager=a;this._maxSlotRefreshCount=4}init(){this._slotManager.displaying.on(a=>
{E.pushToQueue(()=>{a.forEach(b=>b.setTargeting({key:"refresh",value:"00"}));a.forEach(b=>b.setTargeting({key:"nref",value:"0"}))})});this._slotManager.refreshing.on(a=>{E.pushToQueue(()=>{for(let b of a){let c=`0${Math.min(b.refreshCount,this._maxSlotRefreshCount)}`.slice(-2);b.setTargeting({key:"refresh",value:c});b.setTargeting({key:"nref",value:b.refreshCount.toString()})}})})}};Bh=l([n("RefreshCountComponent"),t(),k("design:paramtypes",[V])],Bh);let od=class extends K{constructor(a,b){super();
this._result=!0;this.key="rebuildslot";this._choices=[{choice:!0},{choice:!1}];this.weight=.95;if(b=b.getCoreExperimentButMutateWeights(this.key))this.weight=b.variants[0].weight,this._result=this.run(),a.set(this.key,this._result?"on":"off")}get result(){return this._result}run(){return(new O(this.weight)).get()}};l([N(),k("design:type",Function),k("design:paramtypes",[]),k("design:returntype",void 0)],od.prototype,"run",null);od=l([n("RefreshRebuildExperiment"),p(),k("design:paramtypes",[I,aa])],
od);let Ch=class extends C{constructor(a,b){super();this._slotManager=a;this._refreshRebuildExperiment=b}init(){this._slotManager.refreshing.on(a=>{a.filter(this.slotHasHighRefreshCountIncrement).forEach(b=>this._slotManager.rebuild(b))})}slotHasHighRefreshCountIncrement(a){return 0===a.refreshCount%100}get enabled(){return this._refreshRebuildExperiment.result}};Ch=l([n("RefreshRebuildComponent"),t(),k("design:paramtypes",[V,od])],Ch);let Dh=class extends C{constructor(a,b,c,d,e,g,h,m,q,w){super();
this._config=a;this._spaEventBus=b;this._slotManager=c;this._prebidActionManager=d;this._prebidMethods=e;this._singlePageAppManagerExperiment=g;this._dynamicAdsComponent=h;this._intersectionObserverManager=m;this._gam=q;this._adInjectionMap=w;this._observerDebounceDuration=this._routeChangeBufferDuration=500;this._observerSettledDuration=1E3;this._lastContentMutationTimestamp=Infinity;this._lastHref=document.location.href.split("#")[0];this._isTransitioning=!1}start(){this._addRouteChangeObserver();
this._setupRouteChangeListener()}get enabled(){return this._singlePageAppManagerExperiment.result}_setupRouteChangeListener(){this._spaEventBus.routeChanged.on(a=>{this._handleRouteChange().catch(b=>{r.error("SinglePageAppManagerComponent","routeChanged",b);this._isTransitioning=!1})})}_resetStatefulEmitters(){Wi.forEach(a=>{a.resetEmitted();a.resetOnces()})}async _handleRouteChange(){var a,b;let c=()=>{const d=document.location.href.split("#")[0];return d&&d!==this._lastHref};this._isTransitioning=
!0;this._config.disableAds.clear();this._intersectionObserverManager.unobserveAll(!1);this._adInjectionMap.reset();await tj(this._routeChangeBufferDuration);if(c())throw Error("Handler canceled after route change buffer.");this._slotManager.removeAllElements();this._prebidActionManager.reset();this._prebidMethods.clearAllAuctions();this._slotManager.destroyAll();this._refreshPageviewKey();$d.resetTimeOrigin();this._config.disableAds.init();this._config.context.sessionKey=this._config.context.setSessionKey();
this._config.context.isFirstPageview=this._config.context.checkIsFirstPageview();this._config.context.pageUrl=window.location.href;await this._waitForPageMutations();if(c())throw Error("Handler canceled after page settled.");this._resetStatefulEmitters();this._config.resetDynamicAds();null===(a=this._config.clsOptions)||void 0===a?void 0:a.injectedSlots.splice(0,this._config.clsOptions.injectedSlots.length);null===(b=this._config.clsOptions)||void 0===b?void 0:b.injectedVideoSlots.splice(0,this._config.clsOptions.injectedVideoSlots.length);
this._dynamicAdsComponent.start();this._spaEventBus.resetCompleted.emit();this._gam.setTargetingFlag("spa_rc",["1"]);this._isTransitioning=!1}_refreshPageviewKey(){let a=this._config.context.pageviewKey,b=jb();this._config.context.pageviewKey=b;this._gam.setTargeting({key:"pvk",value:b});return a}_addRouteChangeObserver(){document.body?(new MutationObserver(Si(a=>{const b=document.location.href.split("#")[0];if(b&&this._lastHref!==b){try{this._spaEventBus.routeChanged.emit({to:b,from:this._lastHref})}catch(c){r.error.call(r,
"SinglePageAppManagerComponent","_addRouteChangeObserver",'Error while emitting "routeChanged" event',c instanceof Error?c.message:String(c))}this._lastHref=b}else this._isTransitioning&&this._hasPageContentMutated(a)&&(this._lastContentMutationTimestamp=Date.now())},this._observerDebounceDuration,{leading:!0}))).observe(document.body,{childList:!0,subtree:!0,attributes:!0}):r.error("SinglePageAppManagerComponent","_addRouteChangeObserver","DOM is not ready")}async _waitForPageMutations(){try{return await ce({condition:()=>
Date.now()-this._lastContentMutationTimestamp>this._observerSettledDuration})}catch(a){}}_hasPageContentMutated(a){return a.some(b=>{let c="childList"===b.type,d=0<b.addedNodes.length||0<b.removedNodes.length;b=b.target;b=(null===b||void 0===b?void 0:b.id.includes("AdThrive_"))||(null===b||void 0===b?void 0:b.id.includes("google_ad"));return c&&d&&!b})}};Dh=l([n("SinglePageAppManagerComponent"),t(),k("design:paramtypes",[y,ka,V,sb,W,ub,gd,Vb,E,bb])],Dh);let Eh=class extends C{constructor(a){super();
this._singlePageAppManagerExperiment=a}start(){window.camAddRouteObserver&&window.camAddRouteObserver()}get enabled(){return!this._singlePageAppManagerExperiment.result}};Eh=l([n("CamSinglePageAppManagerComponent"),t(),k("design:paramtypes",[ub])],Eh);let Fh=class extends C{constructor(a){super();this._config=a}start(){if(this._config.site.style&&0<this._config.site.style.length)gb(this._config.site.style);else if(this._config.context.styleUrl){var a=this._config.context.styleUrl;const b=document.createElement("link");
b.rel="stylesheet";b.type="text/css";b.href=a;document.head.appendChild(b)}}};Fh=l([n("SiteStyleComponent"),t(),k("design:paramtypes",[y])],Fh);let Gh=class extends C{constructor(a,b){super();this._gam=a;this._config=b}init(){let a=this.getReferrer();null!==a&&this._gam.setTargeting({key:"doc_ref",value:a})}getReferrer(){let a=Xd(this._config.context.savedReferrer);a&&a.length&&H.setLocalStorageValue("referrer",a);return a}};Gh=l([n("TrafficSourceComponent"),t(),k("design:paramtypes",[E,y])],Gh);
let Hh=class extends C{constructor(a,b){super();this._config=a;this._gam=b}init(){let a=B(H.getLocalStorageValue("utm",!0,18E5),{});["utm_medium","utm_campaign","utm_session","utm_source"].forEach(b=>{var c=this._config.context.querystring.get(b);c=B(c,a[b]);this._gam.setTargeting({key:b,value:c});c&&(a[b]=c)});H.setLocalStorageValue("utm",a)}};Hh=l([n("UTMComponent"),t(),k("design:paramtypes",[y,E])],Hh);class gm{constructor(){}init(a){this.setup(a)}}let Ih=class extends Y{init(){this._key="mgtdtw"}};
Ih=l([n("TearDownPlayerExperiment"),p()],Ih);let pd=class extends fe{constructor(a,b){super();this._siteExperiments=a;this._pubabgroup=b;this._positions="bottom-left bottom-right bottom-center top-left top-right top-center".split(" ");this._choices=[];this._mappedChoices=[];this._resultValidator=c=>this._positions.includes(c);this._result="control";this.key=sa.MobileStickyPlayerPosition;this.experimentConfig=this._siteExperiments.getSiteExperimentByKey(this.key);this.enabled&&this.experimentConfig&&
(this._choices=this.experimentConfig.variants,this._mappedChoices=this._mapChoices(),this._result=this.run(),this.setExperimentTargeting())}run(){return super.run()}setExperimentTargeting(){if(this.enabled&&this.experimentConfig&&this._isValidResult(this._result)){var a=`${this.experimentConfig.key.toLowerCase()}-${this.experimentConfig.id}`;this._pubabgroup.set(a,`${this._result}`)}else r.error("MobileStickyPlayerPositionSiteExperiment","setExperimentTargeting","() => %o","Experiment targeting requires an experiment config and valid result")}_mapChoices(){return this._choices.map(({weight:a,
value:b})=>({weight:a,choice:String(b)}))}};l([N(),k("design:type",Function),k("design:paramtypes",[]),k("design:returntype",void 0)],pd.prototype,"run",null);pd=l([p(),k("design:paramtypes",[Da,ya])],pd);let Jh=class extends K{constructor(a,b){super();this.abgroup=a;this.key="sppe50";this._result=!1;this._choices=[{choice:!0},{choice:!1}];this.weight=0;a=b.getCoreExperimentButMutateWeights(this.key);Q()&&a&&(this.weight=a.variants[0].weight,this._result=this.run(),this.abgroup.set(this.key,this._result?
"on":"off"))}get result(){return this._result}run(){return(new O(this.weight)).get()}};Jh=l([t(),n("StickyPlayerPositionExperiment"),k("design:paramtypes",[I,aa])],Jh);class bk extends gm{constructor(a,b,c,d,e,g,h,m,q="adthrive-collapse-float",w,u,v,A,G,L,J,D){var P;super();this._playerId=a;this._playlistId=b;this._name=c;this._size=d;this._pageElement=e;this._eventProxy=g;this._vastLoadTimeout=h;this._config=m;this._collapseType=q;this._collapseMobileSizeType=w;this._prebidMethods=u;this._auctionManagers=
v;this._playerType=A;this._isCollapsible=G;this._shouldCollapseOnScrollUp=L;this._saveVideoCloseState=J;this._mobileLocation=D;this.initialAuctionPlayer=!1;this._prerollNum=0;this.imaVersion=this.jwVersion="";this.requestVideoBids=()=>{throw Error("Request video bids not set");};this.buildVideoUrl=()=>{throw Error("Build video url not set");};this.setPlayerInstance=()=>{throw Error("Reset player not set");};this.waitForConsent=()=>{throw Error("Wait for consent not set");};this.collapseCollection=
null;this._defaults={};this._state=0;this._adDurationLogged=this._nextAdFetched=!1;this._isFirstPlay=!0;this._wasClicked=this._calledNextVideo=this._createdSkipContainer=!1;this._canSkip=!0;this._isAdvancePlaylist=!1;this._additionalAdFields=this._adDetails=null;this._tearDownAfterNextAd=this._canTearDown=!1;this._tearDownTimer=null;this._tearDownPlayerTimeout=0;this._stalePlayerTimer=null;this._currentAdDurationWithBuffer=this._currentAdTime=0;this._adTimingBuffer=10;this._defaultAdDuration=30;this._autoplayBehaviorConfig=
{mute:!0};this._topBackgroundElement=null;this._bidMarkedOnCurrentAd=!1;this._baseConfig={advertising:{adscheduleid:"DmULPHgQ",client:"googima",maxRedirects:this._config.video.maxRedirect,requestTimeout:this._config.video.jwRequestTimeout,vastLoadTimeout:this._vastLoadTimeout,vpaidmode:"insecure",vpaidcontrols:!0},generateSEOMetadata:!0,preload:"metadata"};this._spaListeners=[];this._transactionId="";this._userIdTargetingData=[];this._pendingBidRequests=[];this._adPlayMap=new Map;F.resolve(ka).routeChanged.on(()=>
{this._spaListeners.forEach(M=>M());this._spaListeners.length=0});this._prebidAuctionManager=this._auctionManagers.getPrebidAuctionManager();this._stickyPlayerPositionExperiment=F.resolve(Jh);this._topCenterMobileBackgroundCoreExperiment=F.resolve(bc);this._mobileStickyPlayerPositionSiteExperiment=F.resolve(pd);this._videoCloseButtonComponent=F.resolve(md);window.matchMedia&&(a=window.matchMedia(`only screen and (max-width: ${this._config.site.breakpoints.desktop-1}px)`),a.addListener(this._handleWidthBreak.bind(this)),
this._handleWidthBreak(a));a=this._config.video.advancePlaylist;this._isAdvancePlaylist="playlist"===this._playerType?a.playlistPlayer.enabled:a.relatedPlayer.enabled;if("contextual"!==this._playerType||this._isCollapsible&&a)this._tearDownPlayerTimeout=null!==(P=F.resolve(Ih).result)&&void 0!==P?P:0,this._canTearDown=0!==this._tearDownPlayerTimeout&&-1!==this._tearDownPlayerTimeout}get name(){return`${this._name}`}get collapsible(){return this._isCollapsible}get playerContainer(){return this._playerContainer}get playerElement(){return this._playerElement}get size(){return this._size}set videoAdUnit(a){this._videoAdUnit=
a}get videoAdUnit(){return this._videoAdUnit}getJwBoostTargeting(){return{playerID:this._playlistId,...((this.name===x.Video_In_Post_ClicktoPlay_SoundOn||this.name===x.Video_Individual_Autoplay_SOff)&&{mediaID:this._playlistId})}}get transactionId(){return this._transactionId}set transactionId(a){this._transactionId=a}set userIdTargetingData(a){this._userIdTargetingData=a}get userIdTargetingData(){return this._userIdTargetingData}get vp(){return 1>=this._prerollNum?this._prerollNum:9>=this._prerollNum?
2:3}get isPlayerType(){return this._playerType}init(){this.setup()}getDefaults(){return this._defaults}setDefaults(a){this._defaults=a}_createCollapsibleCollection(a){let {playerElement:b,playerContainer:c,footerElement:d,stickyElement:e,mobileHeaderSelector:g}=a;this.collapseCollection={playerInstance:this.playerInstance,playerType:this._playerType,playerState:this._state,playerContainer:c,playerElement:b,topBackgroundElement:this._topBackgroundElement,footerElement:d,stickyElement:e,closeButton:this._closeButton,
closeButtonTimeout:this._config.video.closeButtonTimeout,forceMobile:"desktop"!==this._config.context.device,collapseType:this._collapseType,collapseMobileSizeType:this._collapseMobileSizeType,collapseSubType:"adthrive-collapse-bottom-right",collapseMobileSubType:this._getCollapseMobileSubType(),mobileHeaderSelector:g,collapseTimer:{timeCollapsed:0,isRunning:!1},mediaStarted:!1,shouldCollapseOnScrollUp:this._shouldCollapseOnScrollUp}}_resetAdVars(){this._bidMarkedOnCurrentAd=!1;this._adDetails=null;
this._adDurationLogged=this._nextAdFetched=!1;this._currentAdDurationWithBuffer=this._currentAdTime=0;this._pendingBidRequests.length=0;this._clearStaleTimers()}async _handleNextAdFetch(){this._nextAdFetched||(this._nextAdFetched=!0,this._prerollNum++,await this._fetchBids(),0<this._pendingBidRequests.length&&this._pendingBidRequests[0].then(()=>{void this._fetchBids()}).catch(()=>{}))}async _inViewPlay(){let a=this._config.gdpr;!a.consentCaptured&&a.enabled&&await this.waitForConsent();await this._fetchBids();
void this._triggerAdPlay()}_setPlayerVersions(){let a=this.playerInstance,b=/^[0-9]+.[0-9]+.[0-9]+/.exec(a.version);this.jwVersion=b&&b[0];this.imaVersion=a.plugins&&a.plugins.googima&&a.plugins.googima.version}_getPlayerVersions(){return{imaSDKVersion:this.imaVersion,jwVersion:this.jwVersion}}async _fetchBids(){if(2>this._pendingBidRequests.length){let a=this.requestVideoBids([this]);a&&(this._pendingBidRequests.push(a),await a)}}_playerReady(a){this._startTearDownTimer();this._configureQuality();
this._setPlayerVersions()}_jwSetup(a){a={...this._defaults,...this._baseConfig,...a};if(this.playerInstance.setup)try{this.playerInstance.setup(a),this._handleNonLinearAd(),this._setupEventListeners()}catch(b){r.error("InstreamPlayer","jwSetup","Unexpected issue while setting up JWPlayer",{playerId:this._playerId,err:b})}else r.error("InstreamPlayer","jwSetup","Unexpected issue while setting up JWPlayer",{playerId:this._playerId})}_handleNonLinearAd(){this.playerInstance.on("adImpression",a=>{var b=
Ja(a.ima,"ad")?a.ima.ad:null;if((b=this._getAdDetailsFromAd(b))&&Ja(b,"linear")&&!1===b.linear||"nonlinear"===a.linear){this.playerInstance._nonLinearAd=!0;this.playerInstance.pause();a=document.getElementById(`${this._playlistId}`);let c=a.querySelector("div > div.jw-overlays.jw-reset");c.style.backgroundColor="black";let d=a.querySelector("div.jw-wrapper.jw-reset > div.jw-controls.jw-reset");d.style.zIndex="-1";this.playerInstance.once("adComplete",()=>{this.playerInstance._nonLinearAd=!1;c.style.backgroundColor=
"transparent";d.style.zIndex="";this.playerInstance.play()})}})}async _handleScroll(){let a=this._config.gdpr;!a.consentCaptured&&a.enabled&&await this.waitForConsent();this.collapseCollection&&(this._isFirstPlay&&await this._fetchBids(),ba.handleScroll(this.collapseCollection))}_handleResize(){this.collapseCollection&&ba.handleResize(this.collapseCollection)}_handlePageVisibilityChange(a){this.collapseCollection&&ba.handlePageVisibilityChange(a,this.collapseCollection)}_displayCloseButton(){this.collapseCollection&&
ba.displayCloseButton(this.collapseCollection)}_handleClose(){this.collapseCollection&&(this._saveVideoCloseState&&H.setLocalStorageValue("video_closed",!0),ba.handleClose(this.collapseCollection))}_handleUserClick(){this.collapseCollection&&ba.handleUserClick(this.collapseCollection)}_handleWidthBreak(a){this.collapseCollection&&ba.handleWidthBreak(a,this.collapseCollection)}_handleVideoPlayingEvent(a){a!==this._playlistId&&(this.collapseCollection?ba.handleOtherVideoPlaying(this.collapseCollection):
this.playerInstance.pause(!0))}_handleTitleClick(a){this.collapseCollection.collapseTimer.firstInView&&r.event("jw-player","handleTitleClick",{timeElapsed:Date.now()-this.collapseCollection.collapseTimer.firstInView.valueOf(),link:a.currentTarget.getAttribute("href")})}_handleFooterRefreshedEvent(){this.collapseCollection&&ba.repositionCollapseMobileBottom(this.collapseCollection)}_configureQuality(){if(!qa())this.playerInstance.on("levels",a=>{this.playerInstance.setCurrentQuality(a.levels.length-
1)})}_createPlayerCloseButton(){let a=this._wrapperTitleWrapperElement||this._videoTitleElement;return this._closeButton=this._videoCloseButtonComponent.createPlayerCloseButton(this._handleClose.bind(this),"instream","adthrive-collapse-close",!!a,this._isTopCollapse)}_createPlayerCollapseBackgroundElement(){let a=document.createElement("div");a.classList.add("adthrive-collapse-mobile-background");a.style.width=`${window.innerWidth}px`;a.style.display="inline";a.style.height="0";return a}_createLinkIcon(a){let b=
...
"flex");this._videoTitleElement&&this._setTitleTextForVideoTitleElement(this._videoTitleElement);this._topCollapseVideoTitleElement&&this._setTitleTextForVideoTitleElement(this._topCollapseVideoTitleElement);this._handleResize()}};qd=l([n("ContextualPlayer"),k("design:paramtypes",[Object,String,String,Array,HTMLElement,Qa,y,Boolean,String,String,W,tb,Boolean,String,Object])],qd);let Kh=class extends bk{constructor(a,b,c,d,e,g,h,m,q="adthrive-collapse-float",w,u,v,A,G,L,J,D,P){super(a,b,c,d,g,h,m.video.vastTimeout,
...
of(a);this._hasContentSpecificPlaylist=!!a;a&&(this._playlistId=a,this._playerConfig.playlist=`https://cdn.jwplayer.com/v2/playlists/${a}`);this._playerConfig={...this._playerConfig,...this._autoplayBehaviorConfig};this.initialAuctionPlayer=!0;this._stickyElement=null;this._checkVideoClose()&&(this._state=7);this._footerElement=this._config.video.footerSelector?document.querySelector(this._config.video.footerSelector):null;this._createCollapsibleCollection({playerElement:this._playerElement,playerContainer:this._playerContainer,
...
a.videoAdUnit||{},c=this.getCustParams(a);a=this.getDefaultVideoUrlParams(a);return window.pbjs.adServers.dfp.buildVideoUrl({adUnit:b,params:{...a,cust_params:c}})}buildVideoUrl(a){return this.shouldPrebidRun?this.buildGAMVideoUrlPrebid(a):this.buildGAMVideoUrl(a)}};Lh=l([n("VideoUrlBuilder"),p(),k("design:paramtypes",[I,y,E,ab,xa,Ca,Ha])],Lh);let im=(a=>{let b=!1;return async()=>{if(!b){try{await ce(a)}catch(c){}b=!0}}})({condition:()=>!1,delay:500,maxAttempts:8}),td=class extends ea{init(){this._key=
"vcsu";this._default=!1}run(){return super.run()}};l([N(),k("design:type",Function),k("design:paramtypes",[]),k("design:returntype",void 0)],td.prototype,"run",null);td=l([n("VideoCollapseScrollUpExperiment"),p()],td);let Mh=class extends hm{constructor(a,b,c,d,e,g,h,m,q,w,u,v,A,G,L,J,D,P,M){super(a.video,"VideoManagerComponent");this._config=a;this._bootstrapConfig=b;this._prebidMethods=c;this._auctionManagers=d;this._jwBoostExperiment=e;this._userPageDataLoggingEvent=g;this._collapsibleVideoLoggingStore=
...
let a=Object.keys(this._slotResize);for(let b of a)this._slotResize[b].resizeObserver.disconnect()}};vd=l([n("LayoutShiftComponent"),t(),k("design:paramtypes",[E,V,la,Ra,Nh,wa])],vd);let wd=class extends Fa{constructor(){super(...arguments);this.stickyContainerAdStylingApplied=new z}};wd=l([p()],wd);let Oh=class extends C{constructor(a,b,c,d,e,g){super();this._gam=a;this.parallaxAdsExperiment=b;this._pageManager=c;this._config=d;this._slotManager=e;this._stickyContainerAdsEventBus=g;this._parallaxSlotMap=
...
g?205:g}px)`)};this._parallaxScrollEventOffMap.set(a.id,this._pageManager.scroll.on(()=>c()))}_isParallaxAd(a){a=(a=a.firstChild?a.firstChild:void 0)?getComputedStyle(a).height:"0px";a=Number(a.slice(0,-2));return 600<=a&&750>=a}_rebuildSlot(a){a.sizes=a.sizes.filter(b=>600>b[1]);this._slotManager.rebuild(a);this._slotRebuildComplete.set(a.element.id,!0)}};Oh=l([t(),n("ParallaxAdsComponent"),k("design:paramtypes",[E,xc,wa,y,V,wd])],Oh);let cc=class{constructor(){this.contentAdded=new z}};cc=l([n("InfiniteScrollEvents"),
...
t(),k("design:paramtypes",[y,cc])],Ph);let Qh=class extends Sg{constructor(a,b){super(b);this._config=a;this._adInjectionMap=b;this._count=1}getDynamicElementId(){return`${this._config.gam.prefix}_Infinite_${this._count++}`}};Qh=l([n("InfiniteScrollDynamicAdsInjector"),t(),k("design:paramtypes",[y,bb])],Qh);let Rh=class extends C{constructor(a,b,c,d,e){super();this._config=a;this._events=b;this._injector=c;this._slotManager=d;this._gam=e;this._page=1}init(){this._events.contentAdded.on(a=>{this._page++;
this._config.context.pageviewKey=jb();this._gam.setTargeting({key:"pvk",value:this._config.context.pageviewKey});this.slotsAlreadyInjectedInElement(a)||this.addSlots(a)})}slotsAlreadyInjectedInElement(a){return!!a.querySelector("[id*='AdThrive_Content']")}addSlots(a){let b=this._config.dynamicAds.filter(c=>!(this._config.infiniteScroll.ajaxType&&"Sidebar"===c.location)).filter(c=>be(this._config,c)).filter(c=>c.devices.includes(this._config.context.device)).filter(c=>0===c.pageSelector.length||null!==
...
a.length){let b=0;for(let c=0;c<a.length;c++){const d=ib(a[c]);if(d.valid&&d.elements&&d.elements[0]){b=Ud(d.elements[0]).height;break}}return b}},hi=(a=5)=>{a=5<a?a:5;gb(`
...
this.stickyBlockedSelectors=a.adOptions.stickyBlockedSelectors||[],this.stickyContainerTopCenterVideoExperimentResult=Q()?F.resolve(ii).result:!1,F.resolve(ki))}get enabled(){return(this.stickyContainerAdsExperimentResult||this.stickyContainerRecipeExperimentResult)&&!jm(this.stickyBlockedSelectors)}start(){this.setCSS();this.logOverflow();this._stickyContainerAdEventBus.stickyContainerAdStylingApplied.emit()}setCSS(){if(this.stickyContainerAdsExperimentResult){var a=this.stickyContentHeight;gb(`
  ...
  `);hi(this.stickyHeaderHeight)}this.stickyContainerRecipeExperimentResult&&(a=this.stickyRecipeHeight,gb(`
...
this.config.pubAbGroup.groups;this._googleAdManager.setTargeting({key:"pubab",value:this.pubab})});"off"===Wa().get("at_sticky")&&this.clearSticky();"off"===Wa().get("at_sticky_buckets")&&this.clearStickyBuckets()}init(){let a=0===window.adthrive.bucket.indexOf("hbs-q")||.01>Math.random();a&&hb.event("AdThrive","init","hcstart");this._apiReady=new Promise(c=>this.config.identityApi.apiReady.on(()=>c(!0)));let b=c=>{c.data={abgroup:this.config.abGroup.groupsAsObject,pubab:this.config.pubAbGroup.groupsAsObject,
sess:this.config.context.sessionKey,pvk:this.config.context.pageviewKey,hbho:this.config.hbho.bidders,vbho:this.config.vbho.bidders,spa:this.config.adOptions.spa,...(this.config.context.deliveryVersion&&{lmdv:this.config.context.deliveryVersion}),...(this.config.clsOptions&&this.config.clsOptions.branch&&{clsBranch:this.config.clsOptions.branch}),...(this.config.clsOptions&&this.config.clsOptions.bucket&&{clsBucket:this.config.clsOptions.bucket})}};r.sending.on(()=>b(r));hb.sending.on(()=>b(hb));
...
"clearStickyBuckets","adthrive.clearStickyBuckets() has been called");H.removeLocalStorageValue("branch");H.removeLocalStorageValue("at_sticky_data",!1)}};yd=l([n("AdThrive"),p(),k("design:paramtypes",[y,Dg,V,la,tb,aa,E,ti,ui,rc])],yd);let Lm={domain:"ads.adthrive.com",branch:"main",bucket:"prod",cmp:!0},vi=class extends K{constructor(){super();this.classList=["EmailCaptureHandler"];this._result=!1;this._choices=[{choice:!0},{choice:!1}];this.key="logfltr";this._result=this.run()}get result(){return this._result}run(){return(new O(0)).get()}};
...
loggerFilters:e.result?[]:e.classList};H.init(g);hb.init(g);r.init(g);const h=ia();F.resolve(wi).init(g.gdpr);Sm(g).then(()=>{const m=ia()-h;oa.delay=m;return Om(g)}).then(()=>{}).catch(m=>{"string"===typeof m?r.error("index","load",Error(m)):r.error("index","load",m)})};try{Nm(window.adthrive)||Tm()}catch(a){r.error("index","pre-init",a)}return window.adthrive}()
;